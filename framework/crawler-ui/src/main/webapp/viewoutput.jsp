...
<script type="text/javascript">
  <!--
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewoutput.ApacheManifoldCFViewOutputConnectionStatus")%>',
      ...
      <form class="standardform" name="viewconnection" action="execute.jsp" method="POST">
        ...
        <div class="box-body">
          ...
          <table class="table table-bordered">
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewoutput.NameColon")%>
              </th>
              ...
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewoutput.DescriptionColon")%>
              </th>
              <td class="value" colspan="1"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(description)%>
              </td>
            </tr>
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewoutput.ConnectionTypeColon")%>
              </th>
              <td class="value" colspan="1">
                <nobr><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(connectorName)%>
                </nobr>
              </td>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewoutput.MaxConnectionsColon")%>
              </th>
        ...
        <div class="box-footer clearfix">
          <div class="btn-group">
            ...
            <a href="javascript:void()" onclick='<%="javascript:ReingestAll(\""+org.apache.manifoldcf.ui.util.Encoder.attributeJavascriptEscape(connectionName)+"\")"%>'
            ...
            <a href="javascript:void()" onclick='<%="javascript:RemoveAll(\""+org.apache.manifoldcf.ui.util.Encoder.attributeJavascriptEscape(connectionName)+"\")"%>'
