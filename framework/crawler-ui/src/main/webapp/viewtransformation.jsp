...
<script type="text/javascript">
  ...
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewtransformation.ApacheManifoldCFViewTransformationConnectionStatus")%>',
      ...
      <form class="standardform" name="viewconnection" action="execute.jsp" method="POST">
        ...
        <div class="box-body">
          <table class="table table-bordered">
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewtransformation.NameColon")%>
              </th>
              ...
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewtransformation.DescriptionColon")%>
              </th>
              <td class="value" colspan="1"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(description)%>
              </td>
            </tr>
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewtransformation.ConnectionTypeColon")%>
              </th>
              <td class="value" colspan="1">
                <nobr><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(connectorName)%>
                </nobr>
              </td>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewtransformation.MaxConnectionsColon")%>
              </th>
            ...
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "viewtransformation.ConnectionStatusColon")%>
              </th>
