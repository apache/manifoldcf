...
<head>
	...
	<title>
		MetaCarta Administration: List Authorities
	</title>
...
<body class="standardbody">
    ...
    <table class="page">
      ...
      <tr><td class="navigation"><jsp:include page="navigation.jsp" flush="true"/></td>
       <td class="window">
	<p class="windowtitle">List of Authority Connections</p>
...
%>
		<table class="datatable">
			...
			<tr class="headerrow">
				<td class="columnheader"></td><td class="columnheader">Name</td><td class="columnheader">Description</td><td class="columnheader">Authority&nbsp;Type</td>
...
%>
		<tr <%="class=\""+((i%2==0)?"evendatarow":"odddatarow")+"\""%>>
			<td class="columncell">
				<a href='<%="viewauthority.jsp?connname="+java.net.URLEncoder.encode(name,"UTF-8")%>' alt='<%="View "+com.metacarta.ui.util.Encoder.attributeEscape(name)%>'>View</a>&nbsp;<a href='<%="editauthority.jsp?connname="+java.net.URLEncoder.encode(name,"UTF-8")%>' alt='<%="Edit "+com.metacarta.ui.util.Encoder.attributeEscape(name)%>'>Edit</a>&nbsp;<a href="javascript:void()" onclick='<%="javascript:Delete(\""+com.metacarta.ui.util.Encoder.attributeJavascriptEscape(name)+"\")"%>' alt='<%="Delete "+com.metacarta.ui.util.Encoder.attributeEscape(name)%>'>Delete</a>
			</td>
			<td class="columncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(name)%></td>
			<td class="columncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(description)%></td>
			<td class="columncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(connectorName)%></td>
...
%>
			...
			<tr><td class="message" colspan="5"><a href="editauthority.jsp" alt="Add new connection">Add a new connection</a></td></tr>
		</table>
