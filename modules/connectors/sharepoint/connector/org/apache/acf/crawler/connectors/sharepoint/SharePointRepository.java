/* $Id: SharePointRepository.java 965362 2010-07-19 06:15:50Z kwright $ */
...
*/
public class SharePointRepository extends org.apache.acf.crawler.connectors.BaseRepositoryConnector
{
  public static final String _rcsid = "@(#)$Id: SharePointRepository.java 965362 2010-07-19 06:15:50Z kwright $";

  // Properties we need
  public final static String wsddPathProperty = "org.apache.acf.sharepoint.wsddpath";
...
"</script>\n"
  ...
  */
    ...
    throws LCFException, IOException
  {
    ...
    {
      out.print(
"<input type=\"hidden\" name=\"keystoredata\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(keystore)+"\"/>\n"
      );
    }
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"serverLocation\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(serverLocation)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"        <tr>\n"+
"          <td class=\"value\">\n"+
"            <input type=\"button\" onclick='Javascript:ShpDeleteCertificate(\""+org.apache.acf.ui.util.Encoder.attributeJavascriptEscape(alias)+"\")' alt=\""+"Delete cert "+org.apache.acf.ui.util.Encoder.attributeEscape(alias)+"\" value=\"Delete\"/>\n"+
"          </td>\n"+
...
"<input type=\"hidden\" name=\"serverLocation\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(serverLocation)+"\"/>\n"+
...
"          <td class=\"formcolumncell\">\n"+
"            <nobr>\n"+
"              <input type=\"hidden\" name=\""+"specpath"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(thePath)+"\"/>\n"+
"              "+org.apache.acf.ui.util.Encoder.bodyEscape(thePath)+"\n"+
"            </nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>\n"+
...
"          <td class=\"formcolumncell\">\n"+
"            <nobr>\n"+
"              <input type=\"hidden\" name=\""+"specpath"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(match)+"\"/>\n"+
...
"              <input type=\"hidden\" name=\"specpathstate\" value=\""+pathState+"\"/>\n"
      ...
      {
        out.print(
"              <input type=\"hidden\" name=\"specpathlibrary\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(pathLibrary)+"\"/>\n"
        );
      }
      out.print(
...
"        <tr class=\"formrow\">\n"
      ...
      if (message != null)
      {
        ...
        out.print(
"          <td class=\"formmessage\" colspan=\"4\">"+org.apache.acf.ui.util.Encoder.bodyEscape(message)+"</td>\n"
        );
      }
      else
      {
...
"                <option value=\"\" selected=\"true\">-- Select site --</option>\n"
          ...
          {
            org.apache.acf.crawler.connectors.sharepoint.NameValue childSite = (org.apache.acf.crawler.connectors.sharepoint.NameValue)childSiteList.get(q++);
            out.print(
"                <option value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(childSite.getValue())+"\">"+org.apache.acf.ui.util.Encoder.bodyEscape(childSite.getPrettyName())+"</option>\n"
            );
          }
          out.print(
"              </select>\n"
...
"                <option value=\"\" selected=\"true\">-- Select library --</option>\n"
          ...
          {
            org.apache.acf.crawler.connectors.sharepoint.NameValue childLib = (org.apache.acf.crawler.connectors.sharepoint.NameValue)childLibList.get(q++);
            out.print(
"                <option value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(childLib.getValue())+"\">"+org.apache.acf.ui.util.Encoder.bodyEscape(childLib.getPrettyName())+"</option>\n"
            );
          }
          out.print(
"              </select>\n"
...
"<input type=\"hidden\" name=\"tokencount\" value=\""+Integer.toString(k)+"\"/>\n"
    ...
    i = 0;
    org.apache.acf.crawler.connectors.sharepoint.MatchMap matchMap = new org.apache.acf.crawler.connectors.sharepoint.MatchMap();
    while (i < ds.getChildCount())
    {
      SpecificationNode sn = ds.getChild(i++);
...
"          <td class=\"formcolumncell\">\n"+
"            <nobr>\n"+
"              <input type=\"hidden\" name=\""+"metapath"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(path)+"\"/>\n"+
"              "+org.apache.acf.ui.util.Encoder.bodyEscape(path)+"\n"+
"            </nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>\n"+
...
"          <td class=\"formcolumncell\">\n"
            ...
            while (q < metadataFieldArray.size())
            {
              ...
              out.print(
"              <input type=\"hidden\" name=\""+"metafields"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(field)+"\"/>\n"
              );
            }
            out.print(
"            "+org.apache.acf.ui.util.Encoder.bodyEscape(metadataFieldList.toString())+"\n"+
"          </td>\n"+
"        </tr>\n"
            );
            l++;
...
"              <input type=\"hidden\" name=\"metapath\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(metaPathSoFar)+"\"/>\n"+
"              <input type=\"hidden\" name=\"metapathstate\" value=\""+metaPathState+"\"/>\n"
      );
      if (metaPathLibrary != null)
      {
        out.print(
"              <input type=\"hidden\" name=\"metapathlibrary\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(metaPathLibrary)+"\"/>\n"
        );
      }
      out.print(
"              "+org.apache.acf.ui.util.Encoder.bodyEscape(metaPathSoFar)+"\n"+
"            </nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>\n"+
...
"              <select name=\"metafields\" multiple=\"true\" size=\"5\">\n"
        ...
        while (q < fields.length)
        {
          String field = fields[q++];
          out.print(
"                <option value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(field)+"\"/>"+org.apache.acf.ui.util.Encoder.bodyEscape(field)+"</option>\n"
          );
        }
        out.print(
"              </select>\n"
...
"        <tr class=\"formrow\">\n"
      ...
      {
        out.print(
"          <td class=\"formmessage\" colspan=\"5\">"+org.apache.acf.ui.util.Encoder.bodyEscape(message)+"</td></tr>\n"
        );
      }
      else
      {
...
"<input type=\"hidden\" name=\""+"metafields"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(field)+"\"/>\n"
        ...
        else if (sn.getType().equals("metadatarule"))
        {
          ...
          String pathDescription = "_"+Integer.toString(k);
          out.print(
"<input type=\"hidden\" name=\""+"metapath"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(match)+"\"/>\n"+
"<input type=\"hidden\" name=\""+"metaflav"+pathDescription+"\" value=\""+action+"\"/>\n"
          );
          if (action.equals("include"))
          {
...
"<input type=\"hidden\" name=\""+"metaall"+pathDescription+"\" value=\""+allmetadata+"\"/>\n"
            ...
            while (j < sn.getChildCount())
            {
              ...
              if (node.getType().equals("metafield"))
              {
                ...
                out.print(
"<input type=\"hidden\" name=\""+"metafields"+pathDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(value)+"\"/>\n"
                );
              }
            }
          }
...
"        </tr>\n"
            ...
            out.print(
"        <tr class=\""+(((l % 2)==0)?"evenformrow":"oddformrow")+"\">\n"+
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(completePath)+"</nobr></td>\n"+
...
"        </tr>\n"
        ...
        out.print(
"        <tr class=\""+(((l % 2)==0)?"evenformrow":"oddformrow")+"\">\n"+
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(path)+"</nobr></td>\n"+
...
"          <td class=\"formcolumncell\">"+org.apache.acf.ui.util.Encoder.bodyEscape(metadataFieldList.toString())+"</td>\n"+
"        </tr>\n"
          );
          l++;
        }
