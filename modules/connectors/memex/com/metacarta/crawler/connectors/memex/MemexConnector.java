...
public class MemexConnector extends com.metacarta.crawler.connectors.BaseRepositoryConnector
{
        ...
        */
                ...
                throws MetacartaException, ServiceInterruption
        {
                ...
                if(!connected){
                    // Before doing anything else, verify license
                    MemexLicense license = MemexLicense.getInstance();
