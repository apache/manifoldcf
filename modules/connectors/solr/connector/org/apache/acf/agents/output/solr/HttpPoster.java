/* $Id: HttpPoster.java 966209 2010-07-21 12:32:43Z kwright $ */
...
import org.apache.acf.core.common.Base64;
...
{
  public static final String _rcsid = "@(#)$Id: HttpPoster.java 966209 2010-07-21 12:32:43Z kwright $";

  /** Ingestion buffer size property. */
  public static String ingestBufferSizeProperty = "org.apache.acf.ingest.buffersize";
  public static String ingestCredentialsRealm = "org.apache.acf.ingest.credentialrealm";
  public static String ingestResponseRetryCount = "org.apache.acf.ingest.responseretrycount";
  public static String ingestResponseRetryInterval = "org.apache.acf.ingest.retryinterval";
  public static String ingestRescheduleInterval = "org.apache.acf.ingest.rescheduleinterval";
  public static String ingestURIProperty = "org.apache.acf.ingest.uri";
  public static String ingestUserProperty = "org.apache.acf.ingest.user";
  public static String ingestPasswordProperty = "org.apache.acf.ingest.password";
  public static String ingestMaxConnectionsProperty = "org.apache.acf.ingest.maxconnections";
  ...
  */
    ...
    throws LCFException
  {
    ...
    if (userID != null && userID.length() > 0 && password != null)
    {
      try
      {
        encodedCredentials = new org.apache.acf.core.common.Base64().encodeByteArray((userID+":"+password).getBytes("UTF-8"));
      }
      catch (java.io.UnsupportedEncodingException e)
      {
