...
*/
package com.metacarta.agents.output.lucene;
...
* output.
*/
public class LuceneConnector extends com.metacarta.agents.output.BaseOutputConnector
{
        ...
        */
                ...
                throws MetacartaException
        {
                if (poster == null)
                {
                        String protocol = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_PROTOCOL);
                        if (protocol == null || protocol.length() == 0)
                                throw new MetacartaException("Missing parameter: "+com.metacarta.agents.output.lucene.LuceneConfig.PARAM_PROTOCOL);
                                
                        String server = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_SERVER);
                        if (server == null || server.length() == 0)
                                throw new MetacartaException("Missing parameter: "+com.metacarta.agents.output.lucene.LuceneConfig.PARAM_SERVER);

                        String port = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_PORT);
                        if (port == null || port.length() == 0)
                                port = "80";

                        String webapp = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_WEBAPPNAME);
                        if (webapp == null || webapp.length() == 0)
                                webapp = "";

                        String updatePath = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_UPDATEPATH);
                        if (updatePath == null || updatePath.length() == 0)
                                updatePath = "";

                        String removePath = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_REMOVEPATH);
                        if (removePath == null || removePath.length() == 0)
                                removePath = "";

                        String statusPath = params.getParameter(com.metacarta.agents.output.lucene.LuceneConfig.PARAM_STATUSPATH);
