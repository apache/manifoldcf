...
*/
public class ThrottleSpecManager extends com.metacarta.core.database.BaseTable
{
		...
		throws MetacartaException
	{
		...
		try
		{
			...
			if (existing == null)
			{
				...
				// These are not accessed independently; always accessed simply by being part of a job description.
