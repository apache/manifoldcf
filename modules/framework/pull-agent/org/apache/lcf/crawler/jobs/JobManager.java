  ...
  */
    ...
    throws LCFException
  {
    ...
    sb.append("t0.").append(jobQueue.docIDField).append(" AS identifier,")
      ...
      .append(" WHEN ")
      .append("(").append("t0.").append(jobQueue.statusField).append("=").append(database.quoteSQLString(jobQueue.statusToString(jobQueue.STATUS_PENDING)))
      ...
      .append(" OR ").append("t0.").append(jobQueue.statusField).append("=").append(database.quoteSQLString(jobQueue.statusToString(jobQueue.STATUS_PENDINGPURGATORY)))
      .append(")")
      .append(" AND t0.").append(jobQueue.checkTimeField).append(" IS NULL")
      ...
      .append(" WHEN ")
      .append("(").append("t0.").append(jobQueue.statusField).append("=").append(database.quoteSQLString(jobQueue.statusToString(jobQueue.STATUS_ACTIVE)))
