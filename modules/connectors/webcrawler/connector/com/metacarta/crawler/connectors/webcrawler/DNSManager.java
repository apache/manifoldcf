...
*/
public class DNSManager extends com.metacarta.core.database.BaseTable
{
		...
		throws MetacartaException
	{
		...
		try
		{
			...
			if (existing == null)
			{
				...
				// Let's see if we actually need to do this first.
	...
	*/
	protected static class HostDescription extends com.metacarta.core.cachemanager.BaseDescription
	{
		protected String hostName;
	...
	*/
	protected static class HostExecutor extends com.metacarta.core.cachemanager.ExecutorBase
	{
		// Member variables
