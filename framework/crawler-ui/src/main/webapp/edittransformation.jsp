...
<table class="page">
  ...
  <tr>
    ...
    <td class="darkwindow">
      ...
      %>
      <p class="windowtitle"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.EditTransformationConnection2")%>
      </p>
      <table class="displaytable">
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.NoTransformationConnectorsRegistered")%>
          </td>
        </tr>
      </table>
      <%
        ...
        <table class="tabtable">
          <tr class="tabspacerrow">
            ...
            <td class="remaindertab" rowspan="3">
              ...
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.EditATransformationConnection")%>
              </nobr>
              <%
                }
              %>
          ...
          <tr class="tabrow">
            ...
            <td class="passivetab">
              <nobr>
                <a href="javascript:void(0);" alt='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(tab)+" "+Messages.getAttributeString(pageContext.getRequest().getLocale(),"edittransformation.tab")%>' onclick='<%="javascript:SelectTab(\""+tab+"\");return false;"%>'><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(tab)%>
                </a></nobr>
            </td>
            <%
                }
          ...
          <tr class="tabbodyrow">
            <td class="tabbody" colspan='<%=Integer.toString(tabsArray.size()+1)%>'>
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.NameColon")%>
                    </nobr>
                  </td>
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.DescriptionColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.ConnectionTypeColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
                    <%
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "edittransformation.MaxConnectionsColon")%>
                    </nobr>
                  </td>
