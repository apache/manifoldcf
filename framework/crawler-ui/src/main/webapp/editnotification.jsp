...
<table class="page">
  ...
  <tr>
    ...
    <td class="darkwindow">
      ...
      %>
      <p class="windowtitle"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.EditNotificationConnection2")%>
      </p>
      <table class="displaytable">
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.NoNotificationConnectorsRegistered")%>
          </td>
        </tr>
      </table>
      <%
        ...
        <table class="tabtable">
          <tr class="tabspacerrow">
            ...
            <td class="remaindertab" rowspan="3">
              ...
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.EditANotificationConnection")%>
              </nobr>
              <%
                }
              %>
          ...
          <tr class="tabrow">
            ...
            <td class="passivetab">
              <nobr>
                <a href="javascript:void(0);" alt='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(tab)+" "+Messages.getAttributeString(pageContext.getRequest().getLocale(),"editnotification.tab")%>' onclick='<%="javascript:SelectTab(\""+tab+"\");return false;"%>'><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(tab)%>
                </a></nobr>
            </td>
            <%
                }
          ...
          <tr class="tabbodyrow">
            <td class="tabbody" colspan='<%=Integer.toString(tabsArray.size()+1)%>'>
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.NameColon")%>
                    </nobr>
                  </td>
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.DescriptionColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.ConnectionTypeColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
                    <%
                      if (className.length() > 0) {
                        ...
                        if (value == null) {
                    %>
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.UNREGISTERED")%> <%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(className)%>
                    </nobr>
                    <%
                    } else {
                    %>
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.MaxConnectionsColon")%>
                    </nobr>
                  </td>
