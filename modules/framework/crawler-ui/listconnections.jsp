...
<head>
	...
	<title>
		MetaCarta Administration: List Connections
	</title>
...
%>
		<tr <%="class=\""+((i%2==0)?"evendatarow":"odddatarow")+"\""%>>
			...
			<td class="columncell"><%=((authorityName==null)?"Default (Kerberos)":com.metacarta.ui.util.Encoder.bodyEscape(authorityName))%></td>
