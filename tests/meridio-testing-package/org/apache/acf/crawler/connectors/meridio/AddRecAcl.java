/* $Id: AddRecAcl.java 921329 2010-03-10 12:44:20Z kwright $ */
...
public class AddRecAcl
{
        public static final String _rcsid = "@(#)$Id: AddRecAcl.java 921329 2010-03-10 12:44:20Z kwright $";
        ...
        public static void main(String[] args)
        {
                if (args.length != 7)
                {
                        System.err.println("Usage: AddRecAcl <docurl> <recurl> <username> <password> <docid> <username> <permission>");
                ...
                try
                {
                        ...
                        System.err.println("Successfully added record acl");
                }
                catch (Exception e)
                {
