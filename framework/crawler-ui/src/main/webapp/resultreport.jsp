...
<table class="page">
  ...
  <tr>
    ...
    <td class="window">
      <p class="windowtitle"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.ActivityResultReport")%>
      </p>
      <%
      ...
      <form class="standardform" name="report" action="execute.jsp" method="POST">
        ...
        <table class="displaytable">
          ...
          <tr>
            <td class="description" colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.Connection")%>
            </td>
            ...
            <%
              if (reportConnection.length() > 0) {
            %>
            <td class="description" colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.Activities")%>
            </td>
            <td class="value" colspan="1">
          ...
          <tr>
            <td class="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.StartTime")%>
            </td>
            <td class="value" colspan="3">
              ...
              <select class="schedulepulldown" name='reportstartmonth' size="3">
                ...
                <option value="0" <%=(startMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.January")%>
                </option>
                <option value="1" <%=(startMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.February")%>
                </option>
                <option value="2" <%=(startMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.March")%>
                </option>
                <option value="3" <%=(startMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.April")%>
                </option>
                <option value="4" <%=(startMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.May")%>
                </option>
                <option value="5" <%=(startMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.June")%>
                </option>
                <option value="6" <%=(startMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.July")%>
                </option>
                <option value="7" <%=(startMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.August")%>
                </option>
                <option value="8" <%=(startMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.September")%>
                </option>
                <option value="9" <%=(startMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.October")%>
                </option>
                <option value="10" <%=(startMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.November")%>
                </option>
                <option value="11" <%=(startMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.December")%>
                </option>
              </select>
              <nobr/>
          ...
          <tr>
            <td class="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.EndTime")%>
            </td>
            <td class="value" colspan="3">
              ...
              <select class="schedulepulldown" name='reportendmonth' size="3">
                ...
                <option value="0" <%=(endMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.January")%>
                </option>
                <option value="1" <%=(endMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.February")%>
                </option>
                <option value="2" <%=(endMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.March")%>
                </option>
                <option value="3" <%=(endMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.April")%>
                </option>
                <option value="4" <%=(endMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.May")%>
                </option>
                <option value="5" <%=(endMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.June")%>
                </option>
                <option value="6" <%=(endMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.July")%>
                </option>
                <option value="7" <%=(endMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.August")%>
                </option>
                <option value="8" <%=(endMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.September")%>
                </option>
                <option value="9" <%=(endMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.October")%>
                </option>
                <option value="10" <%=(endMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.November")%>
                </option>
                <option value="11" <%=(endMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.December")%>
                </option>
              </select>
              <nobr/>
          ...
          <tr>
            ...
            <td class="value">
              <input type="text" name="reportresultdesc" size="20" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(reportResultDesc)%>'/></td>
          </tr>
          <tr>
            <td class="separator" colspan="4">
              <hr/>
        ...
        <table class="displaytable">
          <tr class="headerrow">
            ...
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("resultcodebucket");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.ResultClass")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("eventcount");'>
          ...
          <tr <%="class=\"" + ((zz % 2 == 0) ? "evendatarow" : "odddatarow") + "\""%>>
            ...
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(row.getValue("eventcount").toString())%>
            </td>
          </tr>
          <%
              zz++;
          ...
          <tr class="reportfooterrow">
            <td class="reportfootercell">
              <nobr>
                ...
                %>
                <a href="javascript:void(0);" onclick='<%="javascript:SetPosition("+Integer.toString(startRow-rowCount)+");"%>' alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"resultreport.PreviousPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.Previous")%>
                </a>
                <%
                  }
                %>
              ...
              <nobr>
                ...
                %>
                <a href="javascript:void(0);" onclick='<%="javascript:SetPosition("+Integer.toString(startRow+rowCount)+");"%>' alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"resultreport.NextPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.Next")%>
                </a>
                <%
                  }
                %>
            ...
            <td class="reportfootercell">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.Rows")%>
              </nobr>
              <nobr><%=Integer.toString(startRow)%>-<%=(hasMoreRows ? Integer.toString(startRow + rowCount - 1) : "END")%>
              </nobr>
            </td>
            <td class="reportfootercell">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.RowsPerPage")%>
              </nobr>
        ...
        <table class="displaytable">
          <tr>
            <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.PleaseSelectAConnection")%>
            </td>
          </tr>
        </table>
        <%
      ...
      <table class="displaytable">
        ...
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "resultreport.PleaseTryAgainLater")%>
          </td>
        </tr>
      </table>
      <%
