...
<script type="text/javascript">
  ...
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.ApacheManifoldCFEditNotificationConnection")%>',
      '<%=title%>',
      'repositories'
  );
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        <div class="callout callout-warning">
          <p><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.NoNotificationConnectorsRegistered")%>
          </p>
        </div>
      </div>
      <%
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_<%=activeTab%>">
              <div class="form-group">
                <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.NameColon")%>
                </label>
                <%
              ...
              <div class="form-group">
                <label
                    for="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.DescriptionColon")%>
                </label>
            ...
            <div class="tab-pane active" id="tab_<%=activeTab%>">
              <div class="form-group">
                <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editnotification.ConnectionTypeColon")%>
                </label>
