/* $Id: MemexConnector.java 996524 2010-09-13 13:38:01Z kwright $ */
...
public class MemexConnector extends org.apache.manifoldcf.crawler.connectors.BaseRepositoryConnector
{
  public static final String _rcsid = "@(#)$Id: MemexConnector.java 996524 2010-09-13 13:38:01Z kwright $";
  ...
  */
    ...
    throws ManifoldCFException, IOException
  {
    ...
    if (memexServerName == null)
      memexServerName = "";
    String memexServerPort = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_MEMEXSERVERPORT);
    if (memexServerPort == null)
      memexServerPort = "";
    String crawlUser = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_USERID);
    if (crawlUser == null)
      crawlUser = "";
    String crawlUserPassword = parameters.getObfuscatedParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_PASSWORD);
    if (crawlUserPassword == null)
      crawlUserPassword = "";
    String webServerProtocol = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_WEBSERVERPROTOCOL);
    if (webServerProtocol == null)
      webServerProtocol = "http";
    String webServerName = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_WEBSERVERNAME);
    if (webServerName == null)
      webServerName = "";
    String webServerPort = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_WEBSERVERPORT);
    if (webServerPort == null)
      webServerPort = "";
    String characterEncoding = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_CHARACTERENCODING);
    if (characterEncoding == null)
      characterEncoding = "windows-1252";
    String serverTimezone = parameters.getParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_SERVERTIMEZONE);
...
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Crawl user name:</nobr></td><td class=\"value\"><input type=\"text\" size=\"32\" name=\"crawluser\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(crawlUser)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Crawl user password:</nobr></td><td class=\"value\"><input type=\"password\" size=\"32\" name=\"crawluserpassword\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(crawlUserPassword)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"      <select name=\"servertimezone\" size=\"10\">\n"
      ...
      while (k < legalTimezones.length)
      {
        ...
        out.print(
"        <option value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(timezone)+"\" "+(timezone.equals(serverTimezone)?" selected=\"selected\"":"")+">"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(timezone)+"</option>\n"
        );
      }
      out.print(
"      </select>\n"+
...
"<input type=\"hidden\" name=\"servertimezone\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(serverTimezone)+"\"/>\n"
      );
    }
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"webservername\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(webServerName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Web server port:</nobr></td>\n"+
"    <td class=\"value\"><input type=\"text\" size=\"5\" name=\"webserverport\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(webServerPort)+"\"/></td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    }
...
"<input type=\"hidden\" name=\"webservername\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(webServerName)+"\"/>\n"+
"<input type=\"hidden\" name=\"webserverport\" value=\""+webServerPort+"\"/>\n"
  ...
  */
    ...
    throws ManifoldCFException
  {
    ...
    if (memexServerName != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_MEMEXSERVERNAME,memexServerName);
      
    String memexServerPort = variableContext.getParameter("memexserverport");
    if (memexServerPort != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_MEMEXSERVERPORT,memexServerPort);
    
    String crawlUser = variableContext.getParameter("crawluser");
    if (crawlUser != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_USERID,crawlUser);

    String crawlUserPassword = variableContext.getParameter("crawluserpassword");
    if (crawlUserPassword != null)
      parameters.setObfuscatedParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_PASSWORD,crawlUserPassword);

    String webServerProtocol = variableContext.getParameter("webserverprotocol");
    if (webServerProtocol != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_WEBSERVERPROTOCOL,webServerProtocol);
      
    String webServerName = variableContext.getParameter("webservername");
    if (webServerName != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_WEBSERVERNAME,webServerName);
      
    String webServerPort = variableContext.getParameter("webserverport");
    if (webServerPort != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_WEBSERVERPORT,webServerPort);

    String characterEncoding = variableContext.getParameter("characterencoding");
    if (characterEncoding != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_CHARACTERENCODING,characterEncoding);
      
    String serverTimezone = variableContext.getParameter("servertimezone");
    if (serverTimezone != null)
      parameters.setParameter(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.CONFIG_PARAM_SERVERTIMEZONE,serverTimezone);
    return null;
  }
  ...
  */
    ...
    throws ManifoldCFException, IOException
  {
    ...
    while (i < ds.getChildCount())
    {
      ...
      if (sn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_ENTITY))
      {
        String entityName = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME);
        String entityDescription = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_DESCRIPTION);
        ...
        while (kk < sn.getChildCount())
        {
          ...
          if (dsn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_PRIMARYFIELD))
          {
            String fieldName = dsn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME);
            primaryList.add(fieldName);
            overallMap.put(fieldName,fieldName);
          }
          else if (dsn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_METAFIELD))
          {
            String fieldName = dsn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME);
...
"  </tr>\n"
      ...
      try
      {
        org.apache.manifoldcf.crawler.connectors.memex.NameDescription[] entityTypes = listEntityTypes();
        out.print(
"  <input type=\"hidden\" name=\"entitytypecount\" value=\""+Integer.toString(entityTypes.length)+"\"/>\n"
        ...
        {
          org.apache.manifoldcf.crawler.connectors.memex.NameDescription entityType = entityTypes[ii];
...
"      <input type=\"hidden\" name=\""+"entitytype_"+Integer.toString(ii)+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(entityPrefix)+"\"/>\n"+
"      <input type=\"hidden\" name=\""+"entitydesc_"+Integer.toString(ii)+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(entityDisplayName)+"\"/>\n"+
"      <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(entityDisplayName)+":</nobr>\n"+
"    </td>\n"+
"    <td class=\"formcolumncell\">\n"+
...
"        <option value=\"\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>\n"
          ...
          if (primaryFields != null)
          {
            ...
            while (jj < primaryFields.size())
            {
              ...
              out.print(
"        <option value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(primaryField)+"\">"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(primaryField)+"</option>\n"
              );
            }
          }
          out.print(
...
"        <option value=\"\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>\n"
          ...
          while (jj < legalFields.length)
          {
            ...
            {
              out.print(
"        <option value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(legalFieldValue)+"\">"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(legalFieldValue)+"</option>\n"
              );
            }
          }
          out.print(
...
"<input type=\"hidden\" name=\"entitytypecount\" value=\""+Integer.toString(entityMap.size())+"\"/>\n"
      ...
      while (iter.hasNext())
      {
        ...
        out.print(
"<input type=\"hidden\" name=\""+"entitytype_"+Integer.toString(ii)+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(entityType)+"\"/>\n"+
"<input type=\"hidden\" name=\""+"entitydesc_"+Integer.toString(ii)+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(displayName)+"\"/>\n"
        );
        int jj = 0;
        while (jj < primaryFields.size())
        {
          String primaryField = (String)primaryFields.get(jj++);
          out.print(
"<input type=\"hidden\" name=\""+"primaryfields_"+Integer.toString(ii)+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(primaryField)+"\"/>\n"
          );
        }
        ...
        while (iter2.hasNext())
        {
          ...
          out.print(
"<input type=\"hidden\" name=\""+"metadatafields_"+Integer.toString(ii)+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(attrName)+"\"/>\n"
          );
        }
        ii++;
      }
...
"        </tr>\n"
      ...
      while (q < ds.getChildCount())
      {
        ...
        if (sn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_SPECIFICATIONRULE))
        {
          // Grab the appropriate rule data
          String virtualServer = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_VIRTUALSERVER);
          if (virtualServer == null)
            virtualServer = "";
          String entityPrefix = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_ENTITY);
          if (entityPrefix == null)
            entityPrefix = "";
          String entityDescription = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_DESCRIPTION);
          if (entityDescription == null)
            entityDescription = entityPrefix;
          String fieldName = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_FIELDNAME);
          if (fieldName == null)
            fieldName = "";
          String operation = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_OPERATION);
          if (operation == null)
            operation = "";
          String fieldValue = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_FIELDVALUE);
          if (fieldValue == null)
            fieldValue = "";
...
"            <input type=\"hidden\" name=\""+"virtualserver"+pathDescription+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(virtualServer)+"\"/>\n"+
"            <input type=\"hidden\" name=\""+"entityprefix"+pathDescription+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(entityPrefix)+"\"/>\n"+
"            <input type=\"hidden\" name=\""+"entitydescription"+pathDescription+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(entityDescription)+"\"/>\n"+
"            <input type=\"hidden\" name=\""+"fieldname"+pathDescription+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(fieldName)+"\"/>\n"+
"            <input type=\"hidden\" name=\""+"operation"+pathDescription+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(operation)+"\"/>\n"+
"            <input type=\"hidden\" name=\""+"fieldvalue"+pathDescription+"\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(fieldValue)+"\"/>\n"+
...
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape((virtualServer.length()==0)?"(All)":virtualServer)+"</nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape((entityPrefix.length()==0)?"(All)":(entityDescription==null)?entityPrefix:entityDescription)+"</nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape((fieldName.length()==0)?"(All)":(fieldName+" "+operation+" "+fieldValue))+"</nobr>\n"+
"          </td>\n"+
"        </tr>\n"
          );
          l++;
...
"              <a name=\"rule\"/>\n"
      ...
      out.print(
"              <input type=\"hidden\" name=\"rulevirtualserver\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(ruleVirtualServer)+"\"/>\n"+
"              <input type=\"hidden\" name=\"ruleentityprefix\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(ruleEntityPrefix)+"\"/>\n"+
"              <input type=\"hidden\" name=\"ruleentitydescription\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(ruleEntityDescription)+"\"/>\n"+
"              <input type=\"hidden\" name=\"rulefieldname\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(ruleFieldName)+"\"/>\n"+
"              <input type=\"hidden\" name=\"ruleoperation\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(ruleOperation)+"\"/>\n"+
"              <input type=\"hidden\" name=\"rulefieldvalue\" value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(ruleFieldValue)+"\"/>\n"+
"            </nobr>\n"+
"            <br/>\n"+
"            <nobr>\n"+
...
"            <nobr>\n"
      ...
      if (ruleVirtualServer.length() > 0)
      {
        ...
        out.print(
"              "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(ruleVirtualServer)+"\n"
        );
      }
      else
      {
...
"                <option value=\"\" selected=\"true\">-- Select Virtual Server --</option>\n"
          ...
          {
            out.print(
"                <option value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(virtualServers[ii])+"\">"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(virtualServers[ii])+"</option>\n"
            );
            ii++;
          }
          out.print(
...
"              "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(e.getMessage())+"\n"
        ...
        {
          out.print(
"              Transient service interruption - "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(e.getMessage())+"\n"
          );
        }
...
"            <nobr>\n"
      ...
      if (ruleEntityPrefix.length() > 0)
      {
        // Display what was chosen
        out.print(
"              "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(ruleEntityDescription)+"\n"
        );
      }
      else
      {
        ...
        if (ruleVirtualServer.length() > 0)
        {
          ...
          try
          {
            ...
            org.apache.manifoldcf.crawler.connectors.memex.NameDescription[] allowedEntities = listDatabasesForVirtualServer(ruleVirtualServer);
            out.print(
...
"              <select name=\"ruleentityselect\" size=\"5\">\n"
            ...
            {
              out.print(
"                <option value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(allowedEntities[ii].getSymbolicName()+":"+allowedEntities[ii].getDisplayName())+"\">"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(allowedEntities[ii].getDisplayName())+"</option>\n"
              );
              ii++;
            }
            out.print(
...
"            <nobr>\n"
      ...
      if (ruleFieldName.length() > 0)
      {
        ...
        out.print(
"              "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(ruleFieldName)+" "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(ruleOperation)+" "+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(ruleFieldValue)+"\n"
        );
      }
      else
      {
...
"                <option value=\"\" selected=\"true\">-- Select Field Name --</option>\n"
            ...
            {
              out.print(
"                <option value=\""+org.apache.manifoldcf.ui.util.Encoder.attributeEscape(fieldNames[ii])+"\">"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(fieldNames[ii])+"</option>\n"
              );
              ii++;
            }
            out.print(
...
"<input type=\"hidden\" name=\"specrulecount\" value=\""+Integer.toString(l)+"\"/>\n"
    ...
    {
      SpecificationNode sn = ds.getChild(i++);
      if (sn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_SECURITY))
      {
        String securityValue = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_VALUE);
        if (securityValue.equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_VALUE_OFF))
          securityOn = false;
        else if (securityValue.equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_VALUE_ON))
          securityOn = true;
      }
    }
...
"  <tr><td class=\"separator\" colspan=\"2\"><hr/></td></tr>\n"
      ...
      {
        SpecificationNode sn = ds.getChild(i++);
        if (sn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_ACCESS))
        {
          String accessDescription = "_"+Integer.toString(k);
          String accessOpName = "accessop"+accessDescription;
          String token = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_TOKEN);
          out.print(
"  <tr>\n"+
...
"</table>\n"
    ...
    {
      out.print(
"<input type=\"hidden\" name=\"specsecurity\" value=\""+(securityOn?org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_VALUE_ON:org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_VALUE_OFF)+"\"/>\n"
      );
    ...
    throws ManifoldCFException
  {
    ...
    if (x != null && x.length() > 0)
    {
      ...
      while (i < count)
      {
        ...
        if (primaryFields != null && primaryFields.length > 0)
        {
          ...
          SpecificationNode node = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_ENTITY);
          node.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME,entityType);
          node.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_DESCRIPTION,displayName);
          
          int k = 0;
          while (k < primaryFields.length)
          {
            SpecificationNode primaryNode = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_PRIMARYFIELD);
            primaryNode.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME,primaryFields[k++]);
          ...
          if (z != null)
          {
            ...
            while (k < z.length)
            {
              SpecificationNode attrNode = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_METAFIELD);
              attrNode.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME,z[k++]);
    ...
    if (x != null && x.length() > 0)
    {
      ...
      while (i < count)
      {
        ...
        {
          SpecificationNode sn = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_SPECIFICATIONRULE);
          if (virtualServer.length() > 0)
            sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_VIRTUALSERVER,virtualServer);
          if (entityPrefix.length() > 0)
            sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_ENTITY,entityPrefix);
          if (entityDescription.length() > 0)
            sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_DESCRIPTION,entityDescription);
          if (fieldName.length() > 0)
            sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_FIELDNAME,fieldName);
          if (operation.length() > 0)
            sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_OPERATION,operation);
          if (fieldValue.length() > 0)
            sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_FIELDVALUE,fieldValue);
      ...
      if (globalOpcode != null && globalOpcode.equals("Add"))
      {
        ...
        SpecificationNode sn = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_SPECIFICATIONRULE);
        if (ruleVirtualServer.length() > 0)
          sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_VIRTUALSERVER,ruleVirtualServer);
        if (ruleEntityPrefix.length() > 0)
          sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_ENTITY,ruleEntityPrefix);
        if (ruleEntityDescription.length() > 0)
          sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_DESCRIPTION,ruleEntityDescription);
        if (ruleFieldName.length() > 0)
          sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_FIELDNAME,ruleFieldName);
        if (ruleOperation.length() > 0)
          sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_OPERATION,ruleOperation);
        if (ruleFieldValue.length() > 0)
          sn.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_FIELDVALUE,ruleFieldValue);
        ds.addChild(ds.getChildCount(),sn);
        ruleVirtualServer = "";
        ruleEntityPrefix = "";
        ruleEntityDescription = "";
    ...
    if (xc != null)
    {
      ...
      SpecificationNode node = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_SECURITY);
      node.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_VALUE,xc);
      ds.addChild(ds.getChildCount(),node);
    ...
    if (xc != null)
    {
      ...
      while (i < accessCount)
      {
        ...
        SpecificationNode node = new SpecificationNode(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_ACCESS);
        node.setAttribute(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_TOKEN,accessSpec);
        ds.addChild(ds.getChildCount(),node);
        i++;
      }
...
"        </tr>\n"
        ...
        out.print(
"        <tr class=\""+(((l % 2)==0)?"evenformrow":"oddformrow")+"\">\n"+
"          <td class=\"formcolumncell\"><nobr>"+((virtualServer.length()==0)?"(all)":org.apache.manifoldcf.ui.util.Encoder.bodyEscape(virtualServer))+"</nobr></td>\n"+
"          <td class=\"formcolumncell\"><nobr>"+((entityPrefix.length()==0)?"(all)":org.apache.manifoldcf.ui.util.Encoder.bodyEscape(entityDescription))+"</nobr></td>\n"+
"          <td class=\"formcolumncell\"><nobr>"+((fieldName.length()==0)?"(all)":org.apache.manifoldcf.ui.util.Encoder.bodyEscape(fieldName+" "+operation+" "+fieldValue))+"</nobr></td>\n"+
"        </tr>\n"
        );
        l++;
      }
...
"        </tr>\n"
        ...
        String strEntityName = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME);
        String strEntityDescription = sn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_DESCRIPTION);
        out.print(
"        <tr class=\""+(((z % 2)==0)?"evenformrow":"oddformrow")+"\">\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(strEntityDescription)+"</nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"
        );
        int k = 0;
        while (k < sn.getChildCount())
        {
          ...
          if (dsn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_PRIMARYFIELD))
          {
            String attrName = dsn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME);
            out.print(
"            <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(attrName)+"</nobr><br/>\n"
            );
          }
        }
        out.print(
...
"          <td class=\"formcolumncell\">\n"
        ...
        {
          SpecificationNode dsn = sn.getChild(k++);
          if (dsn.getType().equals(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_NODE_METAFIELD))
          {
            String attrName = dsn.getAttributeValue(org.apache.manifoldcf.crawler.connectors.memex.MemexConnector.SPEC_ATTRIBUTE_NAME);
            out.print(
"            <nobr>"+org.apache.manifoldcf.ui.util.Encoder.bodyEscape(attrName)+"</nobr><br/>\n"
