...
import org.apache.acf.crawler.connectors.meridio.meridiowrapper.DMSearchResults;
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"dmwsServerName\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(dmwsServerName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"dmwsLocation\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(dmwsLocation)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"dmwsProxyHost\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(dmwsProxyHost)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"rmwsServerName\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(rmwsServerName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"rmwsLocation\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(rmwsLocation)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"separator\" colspan=\"2\"><hr/></td>\n"+
"  </tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"rmwsProxyHost\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(rmwsProxyHost)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"webClientServerName\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(webClientServerName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"webClientDocDownloadLocation\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(webClientDocDownloadLocation)+"\"/></td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    }
...
"<input type=\"hidden\" name=\"webClientServerName\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(webClientServerName)+"\"/>\n"+
"<input type=\"hidden\" name=\"webClientServerPort\" value=\""+webClientServerPort+"\"/>\n"+
"<input type=\"hidden\" name=\"webClientDocDownloadLocation\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(webClientDocDownloadLocation)+"\"/>\n"
      );
    }
  }
...
"      <input type=\"hidden\" name=\""+"specpath_"+Integer.toString(k)+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(pathString)+"\"/>\n"+
...
"      </a>\n"+
"    </td>\n"+
"    <td class=\"value\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(pathString)+"</nobr></td>\n"+
"  </tr>\n"
          );
          k++;
        }
...
"  <tr>\n"
      ...
      if (containerType == null)
        containerType = new Integer(org.apache.acf.crawler.connectors.meridio.MeridioClassContents.CLASS);
      ...
      try
      {
        org.apache.acf.crawler.connectors.meridio.MeridioClassContents[] childList;
        if (containerType.intValue() == org.apache.acf.crawler.connectors.meridio.MeridioClassContents.CLASS)
        {
          childList = getClassOrFolderContents(currentInt);
        }
        else
          childList = new org.apache.acf.crawler.connectors.meridio.MeridioClassContents[0];
        out.print(
"    <td class=\"description\">\n"+
"      <input type=\"hidden\" name=\"specpathop\" value=\"Continue\"/>\n"+
"      <input type=\"hidden\" name=\"specpathbase\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(pathSoFar)+"\"/>\n"+
...
"          <option value=\"\" selected=\"\">-- Pick a folder --</option>\n"
          ...
          while (j < childList.length)
          {
            ...
            out.print(
"          <option value=\""+Integer.toString(childList[j].classOrFolderId)+";"+Integer.toString(childList[j].containerType)+";"+org.apache.acf.ui.util.Encoder.attributeEscape(childList[j].classOrFolderName)+"\">\n"+
"            "+org.apache.acf.ui.util.Encoder.bodyEscape(childList[j].classOrFolderName)+"\n"+
"          </option>\n"
            );
            j++;
          }
...
"    <td class=\"message\" colspan=\"2\">Service interruption: "+org.apache.acf.ui.util.Encoder.bodyEscape(e.getMessage())+"</td>\n"
      ...
      catch (ACFException e)
      {
        e.printStackTrace();
        out.print(
"    <td class=\"message\" colspan=\"2\">"+org.apache.acf.ui.util.Encoder.bodyEscape(e.getMessage())+"</td>\n"
        );
      }
      out.print(
"  </tr>\n"+
...
"    <td class=\"value\">\n"
      ...
      while (i < allowedMimeTypes.length)
      {
        ...
        out.print(
"      <nobr>\n"+
"        <input type=\"checkbox\" name=\"specmimetypes\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(mimeType)+"\" "+((mimeTypeMap.get(mimeType)!=null)?"checked=\"true\"":"")+">\n"+
...
"</table>\n"
    ...
    else
    {
      ...
      while (iter.hasNext())
      {
        ...
        out.print(
"<input type=\"hidden\" name=\"specmimetypes\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(mimeType)+"\"/>\n"
        );
      }
    }
...
"    <td class=\"value\">\n"
        ...
        while (k < categoryList.length)
        {
          ...
          out.print(
"      <nobr>\n"+
"        <input type=\"checkbox\" name=\"speccategories\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(category)+"\" "+((categoriesMap.get(category)!=null)?"checked=\"true\"":"")+">\n"+
"        "+org.apache.acf.ui.util.Encoder.bodyEscape(category)+"\n"+
"        </input>\n"+
"      </nobr>\n"+
"      <br/>\n"
          );
...
"</table>\n"
    ...
    else
    {
      ...
      while (iter.hasNext())
      {
        ...
        out.print(
"<input type=\"hidden\" name=\"speccategories\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(category)+"\"/>\n"
        );
      }
    }
...
"<input type=\"hidden\" name=\"tokencount\" value=\""+Integer.toString(k)+"\"/>\n"
    ...
    i = 0;
    org.apache.acf.crawler.connectors.meridio.MatchMap matchMap = new org.apache.acf.crawler.connectors.meridio.MatchMap();
    while (i < ds.getChildCount())
    {
      SpecificationNode sn = ds.getChild(i++);
...
"      <input type=\"hidden\" name=\"specproperties_edit\" value=\"true\"/>\n"
        ...
        while (k < propertyList.length)
        {
          ...
          out.print(
"      <nobr>\n"+
"        <input type=\"checkbox\" name=\"specproperties\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(descriptor)+"\" "+((metadataSelected.get(descriptor)!=null)?"checked=\"true\"":"")+">\n"+
"          "+org.apache.acf.ui.util.Encoder.bodyEscape(descriptor)+"\n"+
"        </input>\n"+
"      </nobr>\n"+
"      <br/>\n"
          );
...
"    <td class=\"message\" colspan=\"4\">Service interruption: "+org.apache.acf.ui.util.Encoder.bodyEscape(e.getMessage())+"</td>\n"
      ...
      catch (ACFException e)
      {
        e.printStackTrace();
        out.print(
"    <td class=\"message\" colspan=\"4\">"+org.apache.acf.ui.util.Encoder.bodyEscape(e.getMessage())+"</td>\n"
        );
      }
      out.print(
"  </tr>\n"+
...
"      <input type=\"text\" size=\"16\" name=\"specpathnameattribute\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(pathNameAttribute)+"\"/></nobr>\n"+
"    </td>\n"+
"  </tr>\n"+
"  <tr><td class=\"separator\" colspan=\"4\"><hr/></td></tr>\n"
      );
...
"<input type=\"hidden\" name=\"specproperties_edit\" value=\"true\"/>\n"
      ...
      while (iter.hasNext())
      {
        ...
        out.print(
"<input type=\"hidden\" name=\"specproperties\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(descriptor)+"\"/>\n"
        );
      }
      out.print(
...
"    <td class=\"value\">\n"
    ...
    while (i < sortArray.length)
    {
      ...
      out.print(
"      <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(category)+"</nobr><br/>\n"
      );
    }
    out.print(
"    </td>\n"+
...
"    <td class=\"value\">\n"
    ...
    while (i < sortArray.length)
    {
      ...
      out.print(
"      <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(mimeType)+"</nobr><br/>\n"
      );
    }
    out.print(
"    </td>\n"+
...
"    <td class=\"value\">\n"
      ...
      while (i < sortArray.length)
      {
        ...
        out.print(
"      <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(descriptor)+"</nobr><br/>\n"
        );
      }
      out.print(
"    </td>\n"
...
"          <td class=\"value\">--></td><td class=\"value\">"+org.apache.acf.ui.util.Encoder.bodyEscape(replaceString)+"</td>\n"+
"        </tr>\n"
        );
        i++;
      }
