...
"</script>\n"
  ...
  */
  public void outputConfigurationBody(IThreadContext threadContext, IHTTPOutput out, ConfigParams parameters, String tabName)
    throws LCFException, IOException
  {
    String memexServerName = parameters.getParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_MEMEXSERVERNAME);
    if (memexServerName == null)
      memexServerName = "";
    String memexServerPort = parameters.getParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_MEMEXSERVERPORT);
    if (memexServerPort == null)
      memexServerPort = "";
    String crawlUser = parameters.getParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_USERID);
    if (crawlUser == null)
      crawlUser = "";
    String crawlUserPassword = parameters.getObfuscatedParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_PASSWORD);
    if (crawlUserPassword == null)
      crawlUserPassword = "";
    String userNameMapping = parameters.getParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_USERNAMEMAPPING);
    if (userNameMapping == null)
      userNameMapping = "^([^\\\\@]*).*$=$(1)";
    String characterEncoding = parameters.getParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_CHARACTERENCODING);
    if (characterEncoding == null)
      characterEncoding = "windows-1252";

    org.apache.acf.crawler.connectors.memex.MatchMap matchMap = new org.apache.acf.crawler.connectors.memex.MatchMap(userNameMapping);
...
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Authorization user name:</nobr></td><td class=\"value\"><input type=\"text\" size=\"32\" name=\"crawluser\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(crawlUser)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Authorization user password:</nobr></td><td class=\"value\"><input type=\"password\" size=\"32\" name=\"crawluserpassword\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(crawlUserPassword)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"    <td class=\"value\"><input type=\"text\" size=\"40\" name=\"memexuserexpr\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(memexUserExpr)+"\"/></td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    }
...
"<input type=\"hidden\" name=\"memexuserexpr\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(memexUserExpr)+"\"/>\n"
      );
    }
  }
  ...
  */
    ...
    throws LCFException
  {
    ...
    if (memexServerName != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_MEMEXSERVERNAME,memexServerName);
		
    String memexServerPort = variableContext.getParameter("memexserverport");
    if (memexServerPort != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_MEMEXSERVERPORT,memexServerPort);
	
    String crawlUser = variableContext.getParameter("crawluser");
    if (crawlUser != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_USERID,crawlUser);

    String crawlUserPassword = variableContext.getParameter("crawluserpassword");
    if (crawlUserPassword != null)
      parameters.setObfuscatedParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_PASSWORD,crawlUserPassword);

    String characterEncoding = variableContext.getParameter("characterencoding");
    if (characterEncoding != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_CHARACTERENCODING,characterEncoding);
    ...
    {
      org.apache.acf.crawler.connectors.memex.MatchMap matchMap = new org.apache.acf.crawler.connectors.memex.MatchMap();
      matchMap.appendMatchPair(usernameRegexp,memexUserExpr);
      parameters.setParameter(org.apache.acf.crawler.connectors.memex.MemexAuthority.CONFIG_PARAM_USERNAMEMAPPING,matchMap.toString());
    }
    return null;
  }
