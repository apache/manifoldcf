...
public class MeridioLicense {
    public static final String _rcsid = "@(#)$Id$";
    

    private static MeridioLicense _instance = null;

    private static synchronized void createInstance() {
	if (_instance == null) {
		_instance = new MeridioLicense();
	}
    }   

    public static MeridioLicense getInstance() {
	if (_instance == null) {
	    createInstance();
	}
	return _instance;
	...
	*/
	...
	try
		...
		String connector_prefix = (String)constantsClass.getDeclaredField("MERIDIO_CONNECTOR_PREFIX").get(null);
