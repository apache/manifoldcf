			...
			while (true)
			{
				...
				try
				{
					...
					while (true)
					{
						...
						if (desc != null)
						{
							Metacarta.writeDocumentPriorities(threadContext,mgr,jobManager,new DocumentDescription[]{desc},connectionMap,jobDescriptionMap,queueTracker,currentTime);
							processedCount++;
							continue;
						}
