...
public class TestBase
{
    ...
    throws Exception
  {
    if (currentPath == null)
    {
      ...
      System.setProperty("org.apache.acf.configfile",configFile.getCanonicalFile().getAbsolutePath());
    }
  }
    ...
    throws Exception
  {
    ...
    writeFile(configFile,
      ...
      "<configuration>\n"+
      "  <property name=\"org.apache.acf.databaseimplementationclass\" value=\"org.apache.acf.core.database.DBInterfaceDerby\"/>\n" +
      "  <property name=\"org.apache.acf.derbydatabasepath\" value=\""+currentPathString.replaceAll("\\\\","/")+"\"/>\n" +
