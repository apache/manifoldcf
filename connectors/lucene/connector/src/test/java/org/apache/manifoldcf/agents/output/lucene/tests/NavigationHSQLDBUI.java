...
public class NavigationHSQLDBUI extends BaseUIHSQLDB
{
    ...
    throws Exception
  {
    ...
    selectbox.selectValue(testerInstance.createStringDescription("org.apache.manifoldcf.agents.output.lucene.LuceneConnector"));
    ...
    window = testerInstance.findWindow(null);
    form = window.findForm(testerInstance.createStringDescription("editconnection"));
    // Visit the Lucene Settings tab
    link = window.findLink(testerInstance.createStringDescription("Lucene Settings tab"));
    link.click();
