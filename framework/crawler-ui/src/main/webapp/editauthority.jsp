  ...
  <tr>
    ...
    <td class="darkwindow">
      <%
        if (set2.length == 0) {
      %>
      <p class="windowtitle"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.EditAuthorityConnection")%>
      </p>
      <table class="displaytable">
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoAuthorityGroupsDefinedCreateOneFirst")%>
          </td>
        </tr>
      </table>
      <%
      ...
      <table class="displaytable">
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoAuthorityConnectorsRegistered")%>
          </td>
        </tr>
      </table>
      <%
        ...
        <table class="tabtable">
          <tr class="tabspacerrow">
            ...
            <td class="remaindertab" rowspan="3">
              ...
              %>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.EditAnAuthority")%>
              </nobr>
              <%
                }
              %>
          ...
          <tr class="tabrow">
            ...
            <td class="passivetab">
              <nobr>
                <a href="javascript:void(0);" alt='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(tab)+" "+Messages.getAttributeString(pageContext.getRequest().getLocale(),"editauthority.tab")%>' onclick='<%="javascript:SelectTab(\""+tab+"\");return false;"%>'><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(tab)%>
                </a></nobr>
            </td>
            <%
                }
          ...
          <tr class="tabbodyrow">
            <td class="tabbody" colspan='<%=Integer.toString(tabsArray.size()+1)%>'>
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NameColon")%>
                    </nobr>
                  </td>
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.DescriptionColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.ConnectionTypeColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
                    <%
                      if (className.length() > 0) {
                        ...
                        if (value == null) {
                    %>
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.UNREGISTERED")%> <%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(className)%>
                    </nobr>
                    <%
                    } else {
                    %>
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.AuthorityGroupColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="1">
                    <select name="authoritygroup" size="1">
                      <option value=""><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.SelectAGroup")%>
                      </option>
                      <%
                  ...
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.AuthorizationDomainColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="1">
                    <select name="authdomain" size="1">
                      <option value="" <%=(authDomain == null || authDomain.length() == 0) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.DefaultDomainNone")%>
                      </option>
                      <%
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.PrerequisiteUserMappingColon")%>
                    </nobr>
                  </td>
                  <td class="value" colspan="4">
                    ...
                    <%
                      if (prereq == null) {
                    %>
                    <input type="radio" name="prerequisites" value="" checked="true"/>&nbsp;<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoPrerequisites")%>
                    <br/>
                    <%
                    } else {
                    %>
                    <input type="radio" name="prerequisites" value=""/>&nbsp;<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoPrerequisites")%>
                    <br/>
                    <%
                      }
                    ...
                    %>
                    <input type="radio" name="prerequisites" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(mappingName)%>' checked="true"/>&nbsp;<%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(mappingDescription)%>
                    <br/>
                    <%
                    } else {
                    %>
                    <input type="radio" name="prerequisites" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(mappingName)%>'/>&nbsp;<%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(mappingDescription)%>
                    <br/>
                    <%
                        }
                      }
              ...
              <table class="displaytable">
                ...
                <tr>
                  <td class="description">
                    <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.MaxConnectionsColon")%>
                    </nobr>
                  </td>
