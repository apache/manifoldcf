...
COPY ${MCF_DIST}/connector-lib-proprietary/ ${MCF_HOME}/connector-lib-proprietary/
COPY ${MCF_DIST}/example/ ${MCF_HOME}/example/
COPY ${MCF_DIST}/file-resources/ ${MCF_HOME}/file-resources/
COPY ${MCF_DIST}/lib/ ${MCF_HOME}/lib/
COPY ${MCF_DIST}/multiprocess-file-example/ ${MCF_HOME}/multiprocess-file-example/
