...
<script type="text/javascript">
  ...
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.ApacheManifoldCFMaximumBandwidthReport")%>',
      ...
      <div class="box box-primary">
        <div class="box-body">
          <table class="table table-bordered">
            <tr>
              <th colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Connection")%>
              </th>
              <td colspan="1">
              ...
              <%
                if (reportConnection.length() > 0) {
              %>
              <th colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Activities")%>
              </th>
              <td colspan="1">
            ...
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.StartTime")%>
              </th>
              <td colspan="3">
                <div class="input-group">
                  ...
                  <span
                      class="label"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.on")%></span>
                  <select class="schedulepulldown" name='reportstartmonth'>
                    ...
                    <option
                        value="0" <%=(startMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.January")%>
                    </option>
                    <option
                        value="1" <%=(startMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.February")%>
                    </option>
                    <option
                        value="2" <%=(startMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.March")%>
                    </option>
                    <option
                        value="3" <%=(startMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.April")%>
                    </option>
                    <option
                        value="4" <%=(startMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.May")%>
                    </option>
                    <option
                        value="5" <%=(startMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.June")%>
                    </option>
                    <option
                        value="6" <%=(startMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.July")%>
                    </option>
                    <option
                        value="7" <%=(startMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.August")%>
                    </option>
                    <option
                        value="8" <%=(startMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.September")%>
                    </option>
                    <option
                        value="9" <%=(startMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.October")%>
                    </option>
                    <option
                        value="10" <%=(startMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.November")%>
                    </option>
                    <option
                        value="11" <%=(startMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.December")%>
                    </option>
                  </select>
                  <span class="label">-</span>
            ...
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.EndTime")%>
              </th>
              <td colspan="3">
                <div class="input-group">
                  ...
                  <select class="schedulepulldown" name='reportendminute'>
                    ...
                    %>
                      ...
                      <span class="label">
                        <%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.on")%>
                      </span>
                  <select class="schedulepulldown" name='reportendmonth'>
                    ...
                    <option
                        value="0" <%=(endMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.January")%>
                    </option>
                    <option
                        value="1" <%=(endMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.February")%>
                    </option>
                    <option
                        value="2" <%=(endMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.March")%>
                    </option>
                    <option
                        value="3" <%=(endMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.April")%>
                    </option>
                    <option
                        value="4" <%=(endMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.May")%>
                    </option>
                    <option
                        value="5" <%=(endMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.June")%>
                    </option>
                    <option
                        value="6" <%=(endMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.July")%>
                    </option>
                    <option
                        value="7" <%=(endMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.August")%>
                    </option>
                    <option
                        value="8" <%=(endMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.September")%>
                    </option>
                    <option
                        value="9" <%=(endMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.October")%>
                    </option>
                    <option
                        value="10" <%=(endMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.November")%>
                    </option>
                    <option
                        value="11" <%=(endMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.December")%>
                    </option>
                  </select>
                  <span class="label">-</span>
            ...
            <tr>
              ...
              <td><input type="text" class="form-control" name="reportinterval" size="5"
                         value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(Integer.toString(interval))%>'/>
              </td>
            </tr>
          </table>
        </div>
        <div class="box-footer clearfix">
          <div class="btn-group">
            ...
            <a name="MainButton"><input class="btn btn-primary" type="button"
                                        value="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Go")%>"
                                        onClick="javascript:Go()"
                                        alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.ExecuteThisQuery")%>"/></a>
            <%
            } else {
            %>
            <a name="MainButton"><input class="btn btn-primary" type="button"
                                        value="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Continue")%>"
                                        onClick="javascript:Continue()"
                                        alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Continue")%>"/></a>
            <%
              }
            %>
          </div>
...
%>
        ...
        <div class="box-body">
          <table class="table table-bordered">
            <tr>
              ...
              <th><a href="javascript:void(0);" onclick='javascript:ColumnClick("bytecount");'>
            ...
            <tr>
              ...
              <td><%=new Double(bandwidth).toString()%>
              </td>
              <td>
        ...
        <div class="box-footer clearfix">
          <ul class="pagination pagination-sm no-margin pull-left">
            <%
              if (startRow == 0) {
            %>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Previous")%>
            </a></li>
            <%
            } else {
            %>
            <li><a href="javascript:void(0);"
                   ...
                   alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.PreviousPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Previous")%>
            </a></li>
            <%
              }
              if (hasMoreRows == false) {
            %>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Next")%>
            </a></li>
            <%
            } else {
            %>
            <li><a href="javascript:void(0);"
                   onclick='<%="javascript:SetPosition("+Integer.toString(startRow+rowCount)+");"%>'
                   alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.NextPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Next")%>
            </a></li>
            <%
              }
            %>
          ...
          <ul class="pagination pagination-sm no-margin pull-right">
            <li class="pad">
              <span class="label label-primary">
				<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.Rows")%>
            ...
            <li class="form-inline">
              <div class="input-group input-group-sm">
				...
				<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.RowsPerPage")%></span>
  ...
  %>
  <div class="callout callout-info"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.PleaseSelectAConnection")%>
  </div>
  <%
    }
  %>
  ...
  %>
  <div class="callout callout-warning">
    <%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxbandwidthreport.PleaseTryAgainLater")%>
  </div>
  <%
    }
  %>
