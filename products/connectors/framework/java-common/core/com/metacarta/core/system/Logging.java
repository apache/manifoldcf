...
public class Logging
{
	...
	*/
	public static synchronized void initializeLoggers()
	{
		...
		root = newLogger("com.metacarta.root");
		misc = newLogger("com.metacarta.misc");
		db = newLogger("com.metacarta.db");
		lock = newLogger("com.metacarta.lock");
		cache = newLogger("com.metacarta.cache");
		keystore = newLogger("com.metacarta.keystore");
		perf = newLogger("com.metacarta.perf");
	}
