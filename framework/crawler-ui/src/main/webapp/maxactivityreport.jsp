...
<table class="page">
  ...
  <tr>
    ...
    <td class="window">
      <p class="windowtitle"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.MaximumActivityReport")%>
      </p>
      <%
      ...
      <form class="standardform" name="report" action="execute.jsp" method="POST">
        ...
        <table class="displaytable">
          ...
          <tr>
            <td class="description" colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Connection")%>
            </td>
            ...
            <%
              if (reportConnection.length() > 0) {
            %>
            <td class="description" colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Activities")%>
            </td>
            <td class="value" colspan="1">
          ...
          <tr>
            <td class="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.StartTime")%>
            </td>
          ...
          <tr>
            <td class="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.EndTime")%>
            </td>
            <td class="value" colspan="3">
        ...
        <table class="displaytable">
          <tr class="headerrow">
            ...
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("activitycount");'>
          ...
          <tr <%="class=\"" + ((zz % 2 == 0) ? "evendatarow" : "odddatarow") + "\""%>>
            ...
            <td class="reportcolumncell"><%=new Double(activityRate).toString()%>
            </td>
            <td class="reportcolumncell">
        ...
        <table class="reportfootertable">
          <tr class="reportfooterrow">
            ...
            <td class="reportfootercell">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Rows")%>
              </nobr>
              <nobr><%=Integer.toString(startRow)%>-<%=(hasMoreRows ? Integer.toString(startRow + rowCount - 1) : "END")%>
              </nobr>
            </td>
            <td class="reportfootercell">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.RowsPerPage")%>
              </nobr>
        ...
        <table class="displaytable">
          <tr>
            <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.PleaseSelectAConnection")%>
            </td>
          </tr>
        </table>
        <%
      ...
      <table class="displaytable">
        ...
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.PleaseTryAgainLater")%>
          </td>
        </tr>
      </table>
      <%
