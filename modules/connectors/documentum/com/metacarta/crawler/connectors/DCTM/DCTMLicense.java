 ...
 */
public class DCTMLicense {
    public static final String _rcsid = "@(#)$Id$";
    
    // make this a singleton object
    private static DCTMLicense _instance = null;

    private static synchronized void createInstance() {
	if (_instance == null) {
	    _instance = new DCTMLicense();
	}
    }   

    public static DCTMLicense getInstance() {
	if (_instance == null) {
	    createInstance();
	}
	return _instance;
	...
	*/
	...
	try
		...
		lfs = (LicenseFileService)c.newInstance(new Object[]{"/var/lib/metacarta/license",
			(String)constantsClass.getDeclaredField("DOCUMENTUM_CONNECTOR_PREFIX").get(null)});
	    }
	catch (Exception e)
	    {
	...
	//			     MetaCartaLicenseFileConstants.DOCUMENTUM_CONNECTOR_PREFIX);
    }
