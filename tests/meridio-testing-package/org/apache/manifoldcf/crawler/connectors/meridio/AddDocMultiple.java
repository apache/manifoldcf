/* $Id: AddDocMultiple.java 988245 2010-08-23 18:39:35Z kwright $ */
...
public class AddDocMultiple
{
        public static final String _rcsid = "@(#)$Id: AddDocMultiple.java 988245 2010-08-23 18:39:35Z kwright $";

        private AddDocMultiple()
        {
        }
        ...
        public static void main(String[] args)
        {
                ...
                try
                {
                                ...
                                while (i < filesWithinDir.length)
                                {
                                        ...
                                        while (true)
                                        {
                                                ...
                                                if (categoryID != 0)
                                                {
                                                        ...
                                                        handle.addDocumentToFolder(meridioFolder,localBasePath,fileName,title,d,new DOCUMENT_CUSTOMPROPS[0]);
                                                }
                                                else
                                                {
                                                        handle.addDocumentToFolder(meridioFolder,localBasePath,fileName,title);
                                                }
                        ...
                        System.err.println("Successfully added documents");
                }
                catch (Exception e)
                {
