...
*/
package org.apache.acf.agents.output.gts;
...
"</script>\n"
  ...
  */
    ...
    throws ACFException, IOException
  {
    ...
    String realm = parameters.getParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_REALM);
    if (realm == null)
      realm = "";

    String userID = parameters.getParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_USERID);
    if (userID == null)
      userID = "";
		
    String password = parameters.getObfuscatedParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_PASSWORD);
    if (password == null)
      password = "";
...
"    <td class=\"value\">\n"+
"      <input name=\"ingesturi\" type=\"text\" size=\"32\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(ingestURI)+"\"/>\n"+
"    </td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"</table>\n"
    ...
    else
    {
      ...
      out.print("\n"+
"<input type=\"hidden\" name=\"ingesturi\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(ingestURI)+"\"/>\n"+
...
"<input type=\"hidden\" name=\"password\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(password)+"\"/>\n"
  ...
  */
    ...
    throws ACFException
  {
    ...
    if (ingestURI != null)
      parameters.setParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_INGESTURI,ingestURI);

    String realm = variableContext.getParameter("realm");
    if (realm != null)
      parameters.setParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_REALM,realm);

    String userID = variableContext.getParameter("userid");
    if (userID != null)
      parameters.setParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_USERID,userID);
		
    String password = variableContext.getParameter("password");
    if (password != null)
      parameters.setObfuscatedParameter(org.apache.acf.agents.output.gts.GTSConfig.PARAM_PASSWORD,password);
  ...
  */
    ...
    throws ACFException, IOException
  {
    ...
    while (i < os.getChildCount())
    {
      ...
      if (sn.getType().equals(org.apache.acf.agents.output.gts.GTSConfig.NODE_COLLECTION))
      {
        collectionName = sn.getAttributeValue(org.apache.acf.agents.output.gts.GTSConfig.ATTRIBUTE_VALUE);
      }
      else if (sn.getType().equals(org.apache.acf.agents.output.gts.GTSConfig.NODE_DOCUMENTTEMPLATE))
      {
        documentTemplate = sn.getAttributeValue(org.apache.acf.agents.output.gts.GTSConfig.ATTRIBUTE_VALUE);
      }
    }
...
"    <td class=\"value\">\n"+
"      <input name=\"gts_collectionname\" type=\"text\" size=\"32\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(collectionName)+"\"/>\n"+
"    </td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    ...
    else
    {
      ...
      out.print(
"<input type=\"hidden\" name=\"gts_collectionname\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(collectionName)+"\"/>\n"
      );
    }
...
"    <td class=\"value\">\n"+
"      <textarea rows=\"10\" cols=\"96\" name=\"gts_documenttemplate\">"+org.apache.acf.ui.util.Encoder.bodyEscape(documentTemplate)+"</textarea>\n"+
"    </td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    ...
    else
    {
      ...
      out.print(
"<input type=\"hidden\" name=\"gts_documenttemplate\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(documentTemplate)+"\"/>\n"
      );
    }
  }
  ...
  */
    ...
    throws ACFException
  {
    ...
    if (collectionName != null)
    {
      ...
      {
        SpecificationNode newspec = new SpecificationNode(org.apache.acf.agents.output.gts.GTSConfig.NODE_COLLECTION);
        newspec.setAttribute(org.apache.acf.agents.output.gts.GTSConfig.ATTRIBUTE_VALUE,collectionName);
    ...
    if (documentTemplate != null)
    {
      ...
      {
        SpecificationNode sn = os.getChild(i);
        if (sn.getType().equals(org.apache.acf.agents.output.gts.GTSConfig.NODE_DOCUMENTTEMPLATE))
          os.removeChild(i);
        else
          i++;
      }
      SpecificationNode newspec = new SpecificationNode(org.apache.acf.agents.output.gts.GTSConfig.NODE_DOCUMENTTEMPLATE);
      newspec.setAttribute(org.apache.acf.agents.output.gts.GTSConfig.ATTRIBUTE_VALUE,documentTemplate);
      os.addChild(os.getChildCount(),newspec);
    }
...
"    <td class=\"value\">"+org.apache.acf.ui.util.Encoder.bodyEscape(collectionName)+"</td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Document template:</nobr></td>\n"+
"    <td class=\"value\">\n"
    ...
    {
      out.print(
"        <textarea name=\"documenttemplate\" cols=\"96\" rows=\"5\" readonly=\"true\">"+org.apache.acf.ui.util.Encoder.bodyEscape(documentTemplate)+"</textarea>\n"
      );
    }
    out.print(
"    </td>\n"+
