/* $Id: ActiveDirectoryAuthority.java 959015 2010-06-29 16:00:57Z kwright $ */
...
*/
package org.apache.acf.authorities.authorities.activedirectory;
...
*/
public class ActiveDirectoryAuthority extends org.apache.acf.authorities.authorities.BaseAuthorityConnector
{
  public static final String _rcsid = "@(#)$Id: ActiveDirectoryAuthority.java 959015 2010-06-29 16:00:57Z kwright $";
...
"</script>\n"
  ...
  */
    ...
    throws LCFException, IOException
  {
    ...
    String userName = parameters.getParameter(org.apache.acf.authorities.authorities.activedirectory.ActiveDirectoryConfig.PARAM_USERNAME);
    if (userName == null)
      userName = "";
    String password = parameters.getObfuscatedParameter(org.apache.acf.authorities.authorities.activedirectory.ActiveDirectoryConfig.PARAM_PASSWORD);
    if (password == null)
      password = "";
...
"    <td class=\"value\"><input type=\"text\" size=\"64\" name=\"domaincontrollername\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(domainControllerName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"</table>\n"
    ...
    else
    {
      ...
      out.print(
"<input type=\"hidden\" name=\"domaincontrollername\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(domainControllerName)+"\"/>\n"+
...
"<input type=\"hidden\" name=\"password\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(password)+"\"/>\n"
  ...
  */
    ...
    throws LCFException
  {
    ...
    if (domainControllerName != null)
      parameters.setParameter(org.apache.acf.authorities.authorities.activedirectory.ActiveDirectoryConfig.PARAM_DOMAINCONTROLLER,domainControllerName);
    String userName = variableContext.getParameter("username");
    if (userName != null)
      parameters.setParameter(org.apache.acf.authorities.authorities.activedirectory.ActiveDirectoryConfig.PARAM_USERNAME,userName);
    String password = variableContext.getParameter("password");
    if (password != null)
      parameters.setObfuscatedParameter(org.apache.acf.authorities.authorities.activedirectory.ActiveDirectoryConfig.PARAM_PASSWORD,password);
    return null;
  }
