...
<head>
	...
	<title>
		MetaCarta Administration: Simple History Report
	</title>
...
%>
		    <tr <%="class=\""+((zz%2==0)?"evendatarow":"odddatarow")+"\""%>>
		        ...
		        <td class="reportcolumncell"><nobr><%=com.metacarta.ui.util.Encoder.bodyEscape(row.getValue("activity").toString())%></nobr></td>
...
%>
		        ...
		        <td class="reportcolumncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(resultCode)%></td>
		        <td class="reportcolumncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(row.getValue("bytes").toString())%></td>
		        <td class="reportcolumncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(row.getValue("elapsedtime").toString())%></td>
		        <td class="reportcolumncell"><%=com.metacarta.ui.util.Encoder.bodyEscape(resultDescription)%></td>
		    </tr>
<%
			zz++;
		}
