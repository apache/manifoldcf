...
public class DBInterfaceFactory
{
		...
		throws MetacartaException
	{
		...
		if (x == null || !(x instanceof IDBInterface))
		{
			...
			// x = new com.metacarta.core.database.DBInterfaceMySQL(context,databaseName,userName,password);
			x = new com.metacarta.core.database.DBInterfacePostgreSQL(context,databaseName,userName,password);
