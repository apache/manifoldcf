...
<%
  ...
  {
%>
            <a name="MainButton"><input class="btn btn-primary" type="button" value="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Go")%>" 
...
<%
    ...
    {
%>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Previous")%></a></li>
<%
    }
    else
    {
%>
            <li><a href="javascript:void(0);" 
                    ...
                    alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.PreviousPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Previous")%></a>
            </li>
<%
    }
    ...
    {
%>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Next")%></a></li>
<%
    }
    else
    {
%>
            <li><a href="javascript:void(0);" 
                    onclick='<%="javascript:SetPosition("+Integer.toString(startRow+rowCount)+");"%>'
                    alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxbandwidthreport.NextPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(),"maxbandwidthreport.Next")%></a></li>
<%
    }
%>
          </ul>
