...
public class WebLicense {
    ...
    private static WebLicense _instance = null;

    private static synchronized void createInstance() {
	if (_instance == null) {
		_instance = new WebLicense();
	}
    }   

    public static WebLicense getInstance() {
	if (_instance == null) {
	    createInstance();
	}
	return _instance;
	...
	try
		...
		String connector_prefix = (String)constantsClass.getDeclaredField("WEB_CONNECTOR_PREFIX").get(null);
