/* $Id: Sanity.java 964269 2010-07-15 00:36:09Z kwright $ */
...
public class Sanity extends TestBase
{
    ...
    throws Exception
  {
    try
    {
      ...
      conn.setClassName("org.apache.acf.crawler.connectors.filesystem.FileConnector");
      ...
      outputConn.setClassName("org.apache.acf.agents.output.nullconnector.NullConnector");
