...
public class Metacarta extends com.metacarta.agents.system.Metacarta
{
	...
	protected static final String workerThreadCountProperty = "com.metacarta.crawler.threads";
	protected static final String deleteThreadCountProperty = "com.metacarta.crawler.deletethreads";
	protected static final String expireThreadCountProperty = "com.metacarta.crawler.expirethreads";
	protected static final String lowWaterFactorProperty = "com.metacarta.crawler.lowwaterfactor";
	protected static final String stuffAmtFactorProperty = "com.metacarta.crawler.stuffamountfactor";

	/** Initialize environment.
	*/
	public static synchronized void initializeEnvironment()
	{
		com.metacarta.authorities.system.Metacarta.initializeEnvironment();

		if (isInitialized != null)
			return;

		isInitialized = new Integer(0);
		com.metacarta.agents.system.Metacarta.initializeEnvironment();
	...
	*/
		...
		throws MetacartaException
	{
		...
		IJobManager jobManager = JobManagerFactory.make(threadcontext);
                com.metacarta.authorities.system.Metacarta.installSystemTables(threadcontext);
                repConnMgr.install();
                repCon.install();
                jobManager.install();
	}
	...
	*/
		...
		throws MetacartaException
	{
		...
		IJobManager jobManager = JobManagerFactory.make(threadcontext);
                ...
                com.metacarta.authorities.system.Metacarta.deinstallSystemTables(threadcontext);
		if (se != null)
			throw se;
	}
