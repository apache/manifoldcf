...
<table class="displaytable">
	...
	<tr>
		<td class="description"><nobr>Server user name:</nobr></td><td class="value"><input type="text" size="32" name="serverusername" value='<%=org.apache.lcf.ui.util.Encoder.attributeEscape(serverUserName)%>'/></td>
	</tr>
	<tr>
		<td class="description"><nobr>Server password:</nobr></td><td class="value"><input type="password" size="32" name="serverpassword" value='<%=org.apache.lcf.ui.util.Encoder.attributeEscape(serverPassword)%>'/></td>
	</tr>
</table>
<%
	}
