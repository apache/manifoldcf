...
import org.apache.acf.agents.common.XMLStream;
import org.apache.acf.agents.common.XMLContext;
import org.apache.acf.agents.common.XMLStringContext;
import org.apache.acf.agents.common.XMLFileContext;
...
"</script>\n"
  ...
  */
    ...
    throws ACFException, IOException
  {
    ...
    if (email == null)
      email = "";
    String robotsUsage = parameters.getParameter(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.PARAMETER_ROBOTSUSAGE);
    if (robotsUsage == null)
      robotsUsage = "all";
...
"    <td class=\"value\">\n"+
"      <input type=\"text\" size=\"32\" name=\"email\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(email)+"\"/>\n"+
"    </td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    ...
    {
      out.print(
"<input type=\"hidden\" name=\"email\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(email)+"\"/>\n"
      );
    }
...
"        </tr>\n"
      ...
      while (i < parameters.getChildCount())
      {
        ...
        if (cn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_BINDESC))
        {
          // A bin description node!  Look for all its parameters.
          String regexp = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_BINREGEXP);
          String isCaseInsensitive = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_INSENSITIVE);
          ...
          while (j < cn.getChildCount())
          {
            ...
            if (childNode.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_MAXCONNECTIONS))
              maxConnections = childNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE);
            else if (childNode.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_MAXKBPERSECOND))
              maxKBPerSecond = childNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE);
            else if (childNode.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_MAXFETCHESPERMINUTE))
              maxFetchesPerMinute = childNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE);
          }
...
"              <input type=\"hidden\" name=\""+"regexp_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(regexp)+"\"/>\n"+
"            </a>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexp)+"</nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
...
"        </tr>\n"
      ...
      {
        ConfigNode cn = parameters.getChild(i++);
        if (cn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_ACCESSCREDENTIAL))
        {
          // A bin description node!  Look for all its parameters.
          String type = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE);
          if (!type.equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_SESSION))
          {
            String regexp = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP);
            String domain = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_DOMAIN);
            if (domain == null)
              domain = "";
...
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr><input type=\"text\" size=\"16\" name=\""+"domain_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(domain)+"\"/></nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr><input type=\"text\" size=\"16\" name=\""+"username_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(userName)+"\"/></nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr><input type=\"password\" size=\"16\" name=\""+"password_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(password)+"\"/></nobr>\n"+
"          </td>\n"+
"        </tr>\n"
            );
            accessCounter++;
...
"              <input type=\"hidden\" name=\""+prefix+"_regexp"+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(regexp)+"\"/>\n"+
"            </a>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexp)+"</nobr>\n"+
...
"              </tr>\n"
            ...
            while (q < cn.getChildCount())
            {
              ...
              if (authPageNode.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_AUTHPAGE))
              {
                String pageRegexp = authPageNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP);
                String pageType = authPageNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE);
                String matchRegexp = authPageNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_MATCHREGEXP);
                if (matchRegexp == null)
                  matchRegexp = "";
...
"                    <input type=\"hidden\" name=\""+authpagePrefix+"_regexp"+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(pageRegexp)+"\"/>\n"+
"                    <input type=\"hidden\" name=\""+authpagePrefix+"_type"+"\" value=\""+pageType+"\"/>\n"+
"                  </a>\n"+
"                </td>\n"+
"\n"+
"                <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(pageRegexp)+"</nobr></td>\n"+
"                <td class=\"formcolumncell\"><nobr>"+pageType+"</nobr></td>\n"+
"                <td class=\"formcolumncell\"><nobr><input type=\"text\" size=\"30\" name=\""+authpagePrefix+"_matchregexp"+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(matchRegexp)+"\"/></nobr></td>\n"
                );
                if (pageType.equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_FORM))
                {
                  out.print(
"                <td class=\"boxcell\">\n"+
"                  <table class=\"formtable\">\n"+
...
"                    </tr>\n"
                  ...
                  while (z < authPageNode.getChildCount())
                  {
                    ...
                    if (paramNode.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_AUTHPARAMETER))
                    {
                      String param = paramNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_NAMEREGEXP);
                      if (param == null)
                        param = "";
                      String value = paramNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE);
                      if (value == null)
                        value = "";
                      String password = paramNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_PASSWORD);
                      if (password == null)
                        password = "";
...
"                      </td>\n"+
"                      <td class=\"formcolumncell\">\n"+
"                        <nobr><input type=\"text\" size=\"30\" name=\""+authParamPrefix+"_param"+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(param)+"\"/></nobr>\n"+
"                      </td>\n"+
"                      <td class=\"formcolumncell\">\n"+
...
"                </td>\n"+
"                <td class=\"formcolumncell\">\n"+
"                  <nobr><input type=\"radio\" name=\""+prefix+"_loginpagetype"+"\" value=\""+org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_FORM+"\" checked=\"\"/>&nbsp;Form name</nobr><br/>\n"+
"                  <nobr><input type=\"radio\" name=\""+prefix+"_loginpagetype"+"\" value=\""+org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_LINK+"\"/>&nbsp;Link target</nobr>\n"+
"                  <nobr><input type=\"radio\" name=\""+prefix+"_loginpagetype"+"\" value=\""+org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_REDIRECTION+"\"/>&nbsp;Redirection</nobr>\n"+
"                </td>\n"+
"                <td class=\"formcolumncell\">\n"+
...
"<input type=\"hidden\" name=\""+"domain_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(domain)+"\"/>\n"+
"<input type=\"hidden\" name=\""+"username_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(userName)+"\"/>\n"+
"<input type=\"hidden\" name=\""+"password_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(password)+"\"/>\n"
            );
            accessCounter++;
          }
        }
...
"<input type=\"hidden\" name=\""+authpagePrefix+"_regexp"+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(pageRegexp)+"\"/>\n"+
"<input type=\"hidden\" name=\""+authpagePrefix+"_type"+"\" value=\""+pageType+"\"/>\n"+
"<input type=\"hidden\" name=\""+authpagePrefix+"_matchregexp"+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(matchRegexp)+"\"/>\n"
                );
                if (pageType.equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_FORM))
                {
                  int z = 0;
...
"        </tr>\n"
      ...
      {
        ConfigNode cn = parameters.getChild(i++);
        if (cn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_TRUST))
        {
          // It's prefix will be...
          String prefix = "trust_" + Integer.toString(trustsCounter);
          // A bin description node!  Look for all its parameters.
          String regexp = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP);
          String trustEverything = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TRUSTEVERYTHING);
...
"        </tr>\n"
          ...
          {
            String trustStore = cn.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TRUSTSTORE);
...
"              <input type=\"hidden\" name=\""+"truststore_"+prefix+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(trustStore)+"\"/>\n"+
"            </a>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexp)+"</nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(shortenedDescription)+"</nobr>\n"+
"          </td>\n"+
"        </tr>\n"
              );
              trustsCounter++;
...
"<input type=\"hidden\" name=\"trust_count\" value=\""+trustsCounter+"\"/>\n"
  ...
  */
    ...
    throws ACFException
  {
    ...
    if (email != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.PARAMETER_EMAIL,email);
    String robotsUsage = variableContext.getParameter("robotsusage");
    if (robotsUsage != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.PARAMETER_ROBOTSUSAGE,robotsUsage);
    ...
    if (x != null && x.length() > 0)
    {
      ...
      while (i < parameters.getChildCount())
      {
        ...
        if (node.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_BINDESC))
      ...
      while (i < count)
      {
        ...
        if (op == null || !op.equals("Delete"))
        {
          ...
          ConfigNode node = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_BINDESC);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_BINREGEXP,regexp);
          if (isCaseInsensitive != null && isCaseInsensitive.length() > 0)
            node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_INSENSITIVE,isCaseInsensitive);
          if (maxConnections != null && maxConnections.length() > 0)
          {
            ConfigNode child = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_MAXCONNECTIONS);
            child.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE,maxConnections);
            node.addChild(node.getChildCount(),child);
          }
          if (rate != null && rate.length() > 0)
          {
            ConfigNode child = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_MAXKBPERSECOND);
            child.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE,rate);
            node.addChild(node.getChildCount(),child);
          }
          if (fetches != null && fetches.length() > 0)
          {
            ConfigNode child = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_MAXFETCHESPERMINUTE);
            child.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE,fetches);
            node.addChild(node.getChildCount(),child);
          }
    ...
    if (x != null && x.length() > 0)
    {
      ...
      {
        ConfigNode node = parameters.getChild(i);
        if (node.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_ACCESSCREDENTIAL)
                                  && !node.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE).equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_SESSION))
          parameters.removeChild(i);
        else
          i++;
      }
      ...
      while (i < count)
      {
        ...
        if (op == null || !op.equals("Delete"))
        {
          ...
          ConfigNode node = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_ACCESSCREDENTIAL);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP,regexp);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE,type);
    ...
    if (x != null && x.length() > 0)
    {
      ...
      while (i < count)
      {
        ...
        if (op == null || !op.equals("Delete"))
        {
          ...
          ConfigNode node = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_ACCESSCREDENTIAL);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP,regexp);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE,org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_SESSION);
          ...
          while (q < loginPageCount)
          {
            ...
            if (authpageOp == null || !authpageOp.equals("Delete"))
            {
              ...
              if (matchRegexp == null)
                matchRegexp = "";
              ConfigNode authPageNode = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_AUTHPAGE);
              authPageNode.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP,pageRegexp);
              authPageNode.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE,pageType);
              authPageNode.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_MATCHREGEXP,matchRegexp);
              if (pageType.equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_FORM))
              {
                ...
                while (z < paramCount)
                {
                  ...
                  if (paramOp == null || !paramOp.equals("Delete"))
                  {
                    ...
                    ConfigNode paramNode = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_AUTHPARAMETER);
                    paramNode.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_NAMEREGEXP,name);
    ...
    if (x != null && x.length() > 0)
    {
      ...
      {
        ConfigNode node = parameters.getChild(i);
        if (node.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_TRUST))
          parameters.removeChild(i);
        else
          i++;
      }
      ...
      while (i < count)
      {
        ...
        if (op == null || !op.equals("Delete"))
        {
          ...
          ConfigNode node = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_TRUST);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP,regexp);
          if (trustall != null && trustall.equals("true"))
            node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TRUSTEVERYTHING,"true");
          else
            node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TRUSTSTORE,truststore);
          parameters.addChild(parameters.getChildCount(),node);
        }
        i++;
      }
      ...
      if (addop != null && addop.equals("Add"))
      {
        ...
        else
        {
          ...
          ConfigNode node = new ConfigNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_TRUST);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP,regexp);
          node.setAttribute(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TRUSTSTORE,mgr.getString());
          parameters.addChild(parameters.getChildCount(),node);
        }
      }
    }
...
"    <td class=\"value\" colspan=\"1\">"+org.apache.acf.ui.util.Encoder.bodyEscape(email)+"</td>\n"+
"    <td class=\"description\" colspan=\"1\"><nobr>Robots usage:</nobr></td>\n"+
"    <td class=\"value\" colspan=\"1\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(robots)+"</nobr></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
...
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexp)+"</nobr></td>\n"+
...
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(domain)+"</nobr></td>\n"+
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(userName)+"</nobr></td>\n"+
"        </tr>\n"
          );
          instanceNumber++;
        }
...
"          <td class=\"boxcell\">\n"
          ...
          while (q < cn.getChildCount())
          {
            ...
            if (authPageNode.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_AUTHPAGE))
            {
              String authURLRegexp = authPageNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_URLREGEXP);
              String pageType = authPageNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_TYPE);
              String authMatchRegexp = authPageNode.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_MATCHREGEXP);
...
"                <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(authURLRegexp)+"</nobr></td>\n"+
"                <td class=\"formcolumncell\"><nobr>"+pageType+"</nobr></td>\n"+
"                <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(authMatchRegexp)+"</nobr></td>\n"+
"                <td class=\"formcolumncell\">\n"
              );
              if (pageType.equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTRVALUE_FORM))
              {
                ...
                while (z < authPageNode.getChildCount())
                {
                  ...
                  if (authParameter.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_AUTHPARAMETER))
                  {
                    String paramName = authParameter.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_NAMEREGEXP);
                    if (paramName == null)
                      paramName = "";
                    String paramValue = authParameter.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_VALUE);
                    if (paramValue == null)
                      paramValue = "";
                    String password = authParameter.getAttributeValue(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.ATTR_PASSWORD);
                    if (password != null && password.length() > 0)
                      paramValue = "*****";
                    out.print(
"                  <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(paramName+": "+paramValue)+"</nobr><br/>\n"
                    );
                  }
                }
              }
...
"        <tr class=\""+(((instanceNumber % 2)==0)?"evenformrow":"oddformrow")+"\">\n"+
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexp)+"</nobr></td>\n"+
"          <td class=\"formcolumncell\">"+org.apache.acf.ui.util.Encoder.bodyEscape(shortenedDescription)+"</td>\n"+
"        </tr>\n"
            );
            instanceNumber++;
          }
  ...
  */
    ...
    throws ACFException, IOException
  {
    ...
    while (i < ds.getChildCount())
    {
      ...
      if (sn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_SEEDS))
      {
        seeds = sn.getValue();
        if (seeds == null)
          seeds = "";
      }
      else if (sn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_INCLUDES))
      {
        inclusions = sn.getValue();
        if (inclusions == null)
          inclusions = "";
      }
      else if (sn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_EXCLUDES))
      {
...
"      <textarea rows=\"25\" cols=\"80\" name=\"seeds\">"+org.apache.acf.ui.util.Encoder.bodyEscape(seeds)+"</textarea>\n"+
"    </td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    ...
    {
      out.print(
"<input type=\"hidden\" name=\"seeds\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(seeds)+"\"/>\n"
      );
    }
...
"              <input type=\"button\" value=\"Delete\" alt=\""+"Delete url regexp "+org.apache.acf.ui.util.Encoder.attributeEscape(regexpString)+"\" onclick='javascript:URLRegexpDelete("+Integer.toString(l)+",\"urlregexp_"+Integer.toString(l)+"\");'/>\n"+
"            </a>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">\n"+
"            <input type=\"hidden\" name=\""+"urlregexp_"+Integer.toString(l)+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(regexpString)+"\"/>\n"+
"            <input type=\"hidden\" name=\""+"urlregexpdesc_"+Integer.toString(l)+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(description)+"\"/>\n"+
...
"            <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexpString)+"</nobr>\n"+
"          </td>\n"+
"          <td class=\"formcolumncell\">"+org.apache.acf.ui.util.Encoder.bodyEscape(description)+"</td>\n"+
...
"  <tr>\n"+
"    <td class=\"value\" colspan=\"2\">\n"+
"      <textarea rows=\"25\" cols=\"80\" name=\"exclusions\">"+org.apache.acf.ui.util.Encoder.bodyEscape(exclusions)+"</textarea>\n"+
"    </td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    ...
    {
      out.print(
"<input type=\"hidden\" name=\"exclusions\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(exclusions)+"\"/>\n"
      );
    }
...
"      <input type=\"hidden\" name=\""+"specmetaname"+metadataDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(name)+"\"/>\n"+
"      <input type=\"hidden\" name=\""+"specmetavalue"+metadataDescription+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(value)+"\"/>\n"+
...
"    </td>\n"+
"    <td class=\"value\">\n"+
"      "+org.apache.acf.ui.util.Encoder.bodyEscape(name)+"\n"+
"    </td>\n"+
"    <td class=\"value\">=</td>\n"+
"    <td class=\"value\">\n"+
  ...
  */
    ...
    throws ACFException
  {
    ...
    if (seeds != null)
    {
      ...
      SpecificationNode cn = new SpecificationNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_SEEDS);
      cn.setValue(seeds);
    ...
    if (inclusions != null)
    {
      ...
      {
        SpecificationNode sn = ds.getChild(i);
        if (sn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_INCLUDES))
          ds.removeChild(i);
        else
          i++;
      }

      SpecificationNode cn = new SpecificationNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_INCLUDES);
    ...
    if (exclusions != null)
    {
      ...
      {
        SpecificationNode sn = ds.getChild(i);
        if (sn.getType().equals(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_EXCLUDES))
          ds.removeChild(i);
        else
          i++;
      }

      SpecificationNode cn = new SpecificationNode(org.apache.acf.crawler.connectors.webcrawler.WebcrawlerConfig.NODE_EXCLUDES);
        ...
        try
        {
          while (true)
          {
            ...
            if (nextString.length() == 0)
              continue;
            out.print(
"      <nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(nextString)+"</nobr><br/>\n"
            );
          }
        }
        finally
...
"        </tr>\n"
        ...
        out.print(
"        <tr class=\""+(((l % 2)==0)?"evenformrow":"oddformrow")+"\">\n"+
"          <td class=\"formcolumncell\"><nobr>"+org.apache.acf.ui.util.Encoder.bodyEscape(regexpString)+"</nobr></td>\n"+
"          <td class=\"formcolumncell\">"+org.apache.acf.ui.util.Encoder.bodyEscape(description)+"</td>\n"+
...
"    <td class=\"value\">\n"
        ...
        String value = sn.getAttributeValue("value");
        out.print(
"      "+org.apache.acf.ui.util.Encoder.bodyEscape(name)+"&nbsp;=&nbsp;"+org.apache.acf.ui.util.Encoder.bodyEscape(value)+"<br/>\n"
        );
      }
    }
