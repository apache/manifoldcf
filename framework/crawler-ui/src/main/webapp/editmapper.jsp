...
<script type="text/javascript">
  ...
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.ApacheManifoldCFEditMapping")%>',
      '<%=title%>',
      'authorities'
  );
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="callout callout-warning">
      <p><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.NoMappingConnectorsRegistered")%>
      </p>
    </div>
    <%
    } else {
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_<%=activeTab%>">
              <div class="form-group">
                <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.NameColon")%>
                </label>
                <%
              ...
              <div class="form-group">
                <label
                    for="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.DescriptionColon")%>
                </label>
            ...
            <div class="tab-pane active" id="tab_<%=activeTab%>">
              <div class="form-group">
                <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.ConnectionTypeColon")%>
                </label>
                <%
                  if (className.length() > 0) {
            ...
            <div class="tab-pane active" id="tab_<%=activeTab%>">
              <div class="form-group">
                <strong><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.PrerequisiteUserMappingColon")%>
                </strong>
                ...
                <div class="radio">
                  <label>
                    ...
                    <input type="radio" name="prerequisites" value=""
                           checked="true"/>&nbsp;<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.NoPrerequisites")%>
                    <br/>
                    <%
                    } else {
                    %>
                    <input type="radio" name="prerequisites"
                           value=""/>&nbsp;<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.NoPrerequisites")%>
                    <br/>
                    <%
                      }
              ...
              <div class="tab-pane active" id="tab_<%=activeTab%>">
                <div class="form-group">
                  <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editmapper.MaxConnectionsColon")%>
                  </label>
