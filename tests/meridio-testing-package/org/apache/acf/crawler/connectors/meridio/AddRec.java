/* $Id: AddRec.java 921329 2010-03-10 12:44:20Z kwright $ */
...
public class AddRec
{
        public static final String _rcsid = "@(#)$Id: AddRec.java 921329 2010-03-10 12:44:20Z kwright $";
        ...
        public static void main(String[] args)
        {
                ...
                {
                        System.err.println("Usage: AddRec <docurl> <recurl> <username> <password> <folder> <filepath> <filename> <filetitle> [<category>]");
                        System.exit(1);
                }
                ...
                try
                {
                        ...
                        try
                        {
                                if (args[8] != null && args[8].length() > 0)
                                {
                                        ...
                                        long id = handle.addRecordToFolder(args[4],args[5],args[6],args[7],d,new DOCUMENT_CUSTOMPROPS[0]);
                                        UTF8Stdout.print(new Long(id).toString());
                                }
                                else
                                {
                                        long id = handle.addRecordToFolder(args[4],args[5],args[6],args[7]);
                                        UTF8Stdout.print(new Long(id).toString());
                                }
                        }
                        finally
