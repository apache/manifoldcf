...
<%
	...
	if (docbaseName != null)
		parameters.setParameter(com.metacarta.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_DOCBASE,docbaseName);

	String docbaseUserName = variableContext.getParameter("docbaseusername");
	if (docbaseUserName != null)
		parameters.setParameter(com.metacarta.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_USERNAME,docbaseUserName);

	String docbasePassword = variableContext.getParameter("docbasepassword");
	if (docbasePassword != null)
		parameters.setObfuscatedParameter(com.metacarta.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PASSWORD,docbasePassword);

	String docbaseDomain = variableContext.getParameter("docbasedomain");
	if (docbaseDomain != null)
		parameters.setParameter(com.metacarta.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_DOMAIN,docbaseDomain);

	String webtopBaseUrl = variableContext.getParameter("webtopbaseurl");
	if (webtopBaseUrl != null)
		parameters.setParameter(com.metacarta.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_WEBTOPBASEURL,webtopBaseUrl);
