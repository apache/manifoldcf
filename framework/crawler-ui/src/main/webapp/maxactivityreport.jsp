...
<script type="text/javascript">
  <!--
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.ApacheManifoldCFMaximumActivityReport")%>',
      ...
      <div class="box box-primary">
        <div class="box-body">
          <table class="table table-bordered">
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Connection")%>
              </th>
              <td colspan="1">
                <select name="reportconnection" class="form-control">
                  ...
                  %>
                  <option <%=(thisConnectionName.equals(reportConnection)) ? "selected=\"selected\"" : ""%> value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(thisConnectionName)%>'><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(thisDescription)%>
                  </option>
                  <%
                    }
                  %>
              ...
              <%
                if (reportConnection.length() > 0) {
              %>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Activities")%>
              </th>
              <td colspan="1">
                ...
                <select multiple="true" class="selectpicker" name="reportactivities">
                  ...
                  %>
                  <option <%=((selectedActivities.get(activity) == null) ? "" : "selected=\"selected\"")%> value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(activity)%>'><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(activity)%>
                  </option>
                  <%
                    }
                  %>
            ...
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.StartTime")%>
              </th>
              <td colspan="3">
                <div class="input-group">
                    ...
                    <%
                      ...
                      while (k < 24) {
                        ...
                        if (q == 0)
                          q = 12;
                    %>
                    <option value='<%=k%>' <%=(startHour.equals(Integer.toString(k))) ? "selected=\"selected\"" : ""%>><%=Integer.toString(q) + " " + ampm%>
                    </option>
                    <%
                        k++;
                      }
                  ...
                  <select class="schedulepulldown" name='reportstartminute'>
                    ...
                    <%
                      ...
                      while (k < 60) {
                    %>
                    <option value='<%=k%>' <%=(startMinute.equals(Integer.toString(k))) ? "selected=\"selected\"" : ""%>><%=Integer.toString(k)%>
                    </option>
                    <%
                        k++;
                      }
                  ...
                  <select class="schedulepulldown" name='reportstartmonth'>
                    ...
                    <option value="0" <%=(startMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.January")%>
                    </option>
                    <option value="1" <%=(startMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.February")%>
                    </option>
                    <option value="2" <%=(startMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.March")%>
                    </option>
                    <option value="3" <%=(startMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.April")%>
                    </option>
                    <option value="4" <%=(startMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.May")%>
                    </option>
                    <option value="5" <%=(startMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.June")%>
                    </option>
                    <option value="6" <%=(startMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.July")%>
                    </option>
                    <option value="7" <%=(startMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.August")%>
                    </option>
                    <option value="8" <%=(startMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.September")%>
                    </option>
                    <option value="9" <%=(startMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.October")%>
                    </option>
                    <option value="10" <%=(startMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.November")%>
                    </option>
                    <option value="11" <%=(startMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.December")%>
                    </option>
                  </select>
                  <span class="label">-</span>
                    ...
                    <%
                      ...
                      while (k < 31) {
                        ...
                        if (value == 1 && k != 10)
                          ...
                          suffix = "th";
                    %>
                    <option value='<%=Integer.toString(k)%>' <%=(startDay.equals(Integer.toString(k))) ? "selected=\"selected\"" : ""%>><%=Integer.toString(k + 1) + suffix%>
                    </option>
                    <%
                        k++;
                      }
            ...
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.EndTime")%>
              </th>
              <td colspan="3">
                <div class="input-group">
                    ...
                    <%
                      ...
                      while (k < 24) {
                        ...
                        if (q == 0)
                          q = 12;
                    %>
                    <option value='<%=k%>' <%=(endHour.equals(Integer.toString(k))) ? "selected=\"selected\"" : ""%>><%=Integer.toString(q) + " " + ampm%>
                    </option>
                    <%
                        k++;
                      }
                  ...
                  <select class="schedulepulldown" name='reportendminute'>
                    ...
                    <%
                      ...
                      while (k < 60) {
                    %>
                    <option value='<%=k%>' <%=(endMinute.equals(Integer.toString(k))) ? "selected=\"selected\"" : ""%>><%=Integer.toString(k)%>
                    </option>
                    <%
                        k++;
                      }
                  ...
                  <select class="schedulepulldown" name='reportendmonth'>
                    ...
                    <option value="0" <%=(endMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.January")%>
                    </option>
                    <option value="1" <%=(endMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.February")%>
                    </option>
                    <option value="2" <%=(endMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.March")%>
                    </option>
                    <option value="3" <%=(endMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.April")%>
                    </option>
                    <option value="4" <%=(endMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.May")%>
                    </option>
                    <option value="5" <%=(endMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.June")%>
                    </option>
                    <option value="6" <%=(endMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.July")%>
                    </option>
                    <option value="7" <%=(endMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.August")%>
                    </option>
                    <option value="8" <%=(endMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.September")%>
                    </option>
                    <option value="9" <%=(endMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.October")%>
                    </option>
                    <option value="10" <%=(endMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.November")%>
                    </option>
                    <option value="11" <%=(endMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.December")%>
                    </option>
                  </select>
                  <span class="label">-</span>
                    ...
                    <%
                      ...
                      while (k < 31) {
                        ...
                        if (value == 1 && k != 10)
                          ...
                          suffix = "th";
                    %>
                    <option value='<%=Integer.toString(k)%>' <%=(endDay.equals(Integer.toString(k))) ? "selected=\"selected\"" : ""%>><%=Integer.toString(k + 1) + suffix%>
                    </option>
                    <%
                        k++;
                      }
            ...
            <tr>
              ...
              <td>
                <input type="text" class="form-control" name="reportentitymatch" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(entityMatch)%>'/>
              </td>
              <th class="description">
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.ResultCodeMatch")%>
                </nobr>
              </th>
              <td>
                <input type="text" class="form-control" name="reportresultcodematch" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(resultCodeMatch)%>'/>
              </td>
            </tr>
            ...
            <tr>
              <th>
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.IdentifierClassDescription")%>
                </nobr>
              </th>
              <td>
                <input type="text" class="form-control" name="reportbucketdesc" size="20" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(reportBucketDesc)%>'/>
              </td>
              <th>
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.SlidingWindowSize")%>
                </nobr>
              </th>
              <td>
                <input type="text" class="form-control" name="reportinterval" size="5" value='<%=org.apache.manifoldcf.ui.util.Encoder.attributeEscape(Integer.toString(interval))%>'/>
              </td>
            </tr>
          </table>
        </div>
        <div class="box-footer clearfix">
          ...
          <div class="btn-group">
            <%
              if (reportConnection.length() > 0) {
            %>
            <a name="MainButton"><input class="btn btn-primary" type="button" value="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxactivityreport.Go")%>" onClick="javascript:Go()" alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxactivityreport.ExecuteThisQuery")%>"/></a>
            <%
            } else {
            %>
            <a name="MainButton"><input class="btn btn-primary" type="button" value="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxactivityreport.Continue")%>" onClick="javascript:Continue()" alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxactivityreport.Continue")%>"/></a>
            <%
              }
            %>
          </div>
...
%>
      ...
      <div class="box box-primary">
          ...
          <table class="table table-bordered">
            <tr>
              <th><a href="javascript:void(0);" onclick='javascript:ColumnClick("idbucket");'>
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.IdentifierClass")%>
                </nobr>
              </a></th>
              <th><a href="javascript:void(0);" onclick='javascript:ColumnClick("activitycount");'>
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.HighestActivityRate")%>
                </nobr>
              </a></th>
              <th><a href="javascript:void(0);" onclick='javascript:ColumnClick("starttime");'>
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.StartTime")%>
                </nobr>
              </a></th>
              <th><a href="javascript:void(0);" onclick='javascript:ColumnClick("endtime");'>
                <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.EndTime")%>
                </nobr>
              </a></th>
            </tr>
            <%
            ...
            <tr>
              ...
              <td><%=new Double(activityRate).toString()%>
              </td>
              <td>
                <nobr><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(startTimeString)%>
                </nobr>
              </td>
              <td>
                <nobr><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(endTimeString)%>
                </nobr>
              </td>
            </tr>
            <%
        ...
        <div class="box-footer clearfix">
          <ul class="pagination pagination-sm no-margin pull-left">
            ...
            %>
            <li>
              <a href="javascript:void(0);" onclick='<%="javascript:SetPosition("+Integer.toString(startRow-rowCount)+");"%>' alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxactivityreport.PreviousPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Previous")%>
              </a></li>
            <%
              }
            ...
            %>
            <li>
              <a href="javascript:void(0);" onclick='<%="javascript:SetPosition("+Integer.toString(startRow+rowCount)+");"%>' alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"maxactivityreport.NextPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Next")%>
              </a></li>
            <%
              }
            %>
          ...
          <ul class="pagination pagination-sm no-margin pull-right">
            <li class="pad">
              <span class="label label-primary">
				<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.Rows")%>
			...
			<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.RowsPerPage")%></span>
  ...
  %>
  <div class="callout callout-info"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "maxactivityreport.PleaseSelectAConnection")%>
  </div>
  <%
    }
  %>
