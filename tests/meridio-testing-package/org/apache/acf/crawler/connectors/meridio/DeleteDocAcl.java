/* $Id: DeleteDocAcl.java 921329 2010-03-10 12:44:20Z kwright $ */
...
import org.apache.acf.crawler.connectors.meridio.DMDataSet.ACCESSCONTROL;

public class DeleteDocAcl
{
        public static final String _rcsid = "@(#)$Id: DeleteDocAcl.java 921329 2010-03-10 12:44:20Z kwright $";
        ...
        public static void main(String[] args)
        {
                if (args.length != 7)
                {
                        System.err.println("Usage: DeleteDocAcl <docurl> <recurl> <username> <password> <docid> <username> <permission>");
                ...
                try
                {
                        ...
                        System.err.println("Successfully removed document acl");
                }
                catch (Exception e)
                {
