...
"</script>\n"
  ...
  */
    ...
    throws ACFException, IOException
  {
    ...
    if (docbaseName == null)
      docbaseName = "";
    String docbaseUserName = parameters.getParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_USERNAME);
    if (docbaseUserName == null)
      docbaseUserName = "";
    String docbasePassword = parameters.getObfuscatedParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PASSWORD);
    if (docbasePassword == null)
      docbasePassword = "";
    String docbaseDomain = parameters.getParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_DOMAIN);
    if (docbaseDomain == null)
      docbaseDomain = "";
    String webtopBaseUrl = parameters.getParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_WEBTOPBASEURL);
...
"  <tr>\n"+
"    <td class=\"description\"><nobr>Docbase name:</nobr></td><td class=\"value\"><input type=\"text\" size=\"32\" name=\"docbasename\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbaseName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Docbase user name:</nobr></td><td class=\"value\"><input type=\"text\" size=\"32\" name=\"docbaseusername\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbaseUserName)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Docbase password:</nobr></td><td class=\"value\"><input type=\"password\" size=\"32\" name=\"docbasepassword\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbasePassword)+"\"/></td>\n"+
"  </tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Docbase domain:</nobr></td><td class=\"value\"><input type=\"text\" size=\"32\" name=\"docbasedomain\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbaseDomain)+"\"/></td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    }
    else
    {
      ...
      out.print(
"<input type=\"hidden\" name=\"docbasename\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbaseName)+"\"/>\n"+
"<input type=\"hidden\" name=\"docbaseusername\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbaseUserName)+"\"/>\n"+
"<input type=\"hidden\" name=\"docbasepassword\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbasePassword)+"\"/>\n"+
"<input type=\"hidden\" name=\"docbasedomain\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(docbaseDomain)+"\"/>\n"
      );
    }
...
"  <tr><td class=\"separator\" colspan=\"2\"><hr/></td></tr>\n"+
"  <tr>\n"+
"    <td class=\"description\"><nobr>Webtop Base URL:</nobr></td><td class=\"value\"><input type=\"text\" size=\"64\" name=\"webtopbaseurl\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(webtopBaseUrl)+"\"/></td>\n"+
"  </tr>\n"+
"</table>\n"
      );
    }
    else
    {
      ...
      out.print(
"<input type=\"hidden\" name=\"webtopbaseurl\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(webtopBaseUrl)+"\"/>\n"
      );
    }
  }
  ...
  */
    ...
    throws ACFException
  {
    ...
    if (docbaseName != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_DOCBASE,docbaseName);

    String docbaseUserName = variableContext.getParameter("docbaseusername");
    if (docbaseUserName != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_USERNAME,docbaseUserName);

    String docbasePassword = variableContext.getParameter("docbasepassword");
    if (docbasePassword != null)
      parameters.setObfuscatedParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PASSWORD,docbasePassword);

    String docbaseDomain = variableContext.getParameter("docbasedomain");
    if (docbaseDomain != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_DOMAIN,docbaseDomain);

    String webtopBaseUrl = variableContext.getParameter("webtopbaseurl");
    if (webtopBaseUrl != null)
      parameters.setParameter(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_WEBTOPBASEURL,webtopBaseUrl);
...
"  <tr><td class=\"separator\" colspan=\"2\"><hr/></td></tr>\n"
      ...
      while (i < ds.getChildCount())
      {
        ...
        if (sn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_LOCATION))
        {
...
"    </td>\n"+
"    <td class=\"value\">\n"+
"      "+org.apache.acf.ui.util.Encoder.bodyEscape(pathSoFar)+"\n"
        );
...
"<input type=\"hidden\" name=\"tokencount\" value=\""+Integer.toString(k)+"\"/>\n"
    ...
    {
      SpecificationNode sn = ds.getChild(i++);
      if (sn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_OBJECTTYPE))
      {
        String token = sn.getAttributeValue("token");
        if (token != null && token.length() > 0)
        {
          ...
          else
          {
            ...
            while (kk < sn.getChildCount())
            {
              ...
              if (dsn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_ATTRIBUTENAME))
              {
...
"    <td class=\"value\">\n"
            ...
            {
              out.print(
"      <input type=\"checkbox\" name=\"specfiletype\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(strObjectType)+"\">"+org.apache.acf.ui.util.Encoder.bodyEscape(strObjectType)+"</input>\n"
              );
            }
            else
            {
              out.print(
"      <input type=\"checkbox\" name=\"specfiletype\" checked=\"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(strObjectType)+"\">"+org.apache.acf.ui.util.Encoder.bodyEscape(strObjectType)+"</input>\n"
              );
...
"    <td class=\"value\">\n"
            ...
            out.print(
"      <input type=\"checkbox\" name=\""+org.apache.acf.ui.util.Encoder.attributeEscape("specfileallattrs_"+strObjectType)+"\" value=\"true\" "+(isAll?"checked=\"\"":"")+"/>&nbsp;All metadata<br/>\n"+
"      <select multiple=\"true\" name=\""+org.apache.acf.ui.util.Encoder.attributeEscape("specfileattrs_"+strObjectType)+"\" size=\"3\">\n"
            );
            ...
            while (iii < values.length)
            {
              ...
              if (attrMap != null && attrMap.get(option) != null)
              {
                // Selected
                out.print(
"        <option selected=\"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(option)+"\">"+org.apache.acf.ui.util.Encoder.bodyEscape(option)+"</option>\n"
                );
              }
              else
              {
                // Unselected
                out.print(
"        <option value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(option)+"\">"+org.apache.acf.ui.util.Encoder.bodyEscape(option)+"</option>\n"
                );
              }
            }
            out.print(
...
"</table>\n"
    ...
    else
    {
      ...
      while (iter.hasNext())
      {
        ...
        Object o = dtMap.get(strObjectType);
        out.print(
"<input type=\"hidden\" name=\"specfiletype\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(strObjectType)+"\"/>\n"
        );
        if (o instanceof Boolean)
        {
          Boolean b = (Boolean)o;
          out.print(
"<input type=\"hidden\" name=\""+org.apache.acf.ui.util.Encoder.attributeEscape("specfileallattrs_"+strObjectType)+"\" value=\""+(b.booleanValue()?"true":"false")+"\"/>\n"
          );
        }
        else
        {
          ...
          while (iter2.hasNext())
          {
            ...
            out.print(
"<input type=\"hidden\" name=\""+org.apache.acf.ui.util.Encoder.attributeEscape("specfileattrs_"+strObjectType)+"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(attrName)+"\"/>\n"
            );
          }
        }
      }
    ...
    {
      SpecificationNode sn = ds.getChild(i++);
      if (sn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_FORMAT))
      {
...
"    <td class=\"description\">\n"
            ...
            {
              out.print(
"      <input type=\"checkbox\" name=\"specmimetype\" checked=\"\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(strMimeType)+"\"></input>\n"
              );
            }
            else
            {
              out.print(
"      <input type=\"checkbox\" name=\"specmimetype\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(strMimeType)+"\"></input>\n"
              );
            }
            out.print(
"    </td>\n"+
"    <td class=\"value\">\n"+
"      "+org.apache.acf.ui.util.Encoder.bodyEscape(strMimeType)+"\n"+
"    </td>\n"+
"  </tr>\n"
            );
      	  }
    ...
    else
    {
      if (ctMap != null)
      {
        ...
        while (iter.hasNext())
        {
          ...
          out.print(
"<input type=\"hidden\" name=\"specmimetype\" value=\""+org.apache.acf.ui.util.Encoder.attributeEscape(strMimeType)+"\"/>\n"
          );
        }
      }
    }
    ...
    {
      SpecificationNode sn = ds.getChild(i++);
      if (sn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_MAXLENGTH))
      {
...
"<input type=\"hidden\" name=\"specmaxdoclength\" value=\""+maxDocLength+"\"/>\n"
    ...
    {
      SpecificationNode sn = ds.getChild(i++);
      if (sn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PATHNAMEATTRIBUTE))
      {
    ...
    i = 0;
    org.apache.acf.crawler.connectors.DCTM.MatchMap matchMap = new org.apache.acf.crawler.connectors.DCTM.MatchMap();
    while (i < ds.getChildCount())
    {
      SpecificationNode sn = ds.getChild(i++);
      if (sn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PATHMAP))
      {
    ...
    throws ACFException
  {
    ...
    if (x != null)
    {
      ...
      while (i < pathCount)
      {
      	...
      	SpecificationNode node = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_LOCATION);
    ...
    if (y != null)
    {
      ...
      {
      	String fileType = y[i++];
      	SpecificationNode node = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_OBJECTTYPE);
          ...
          while (k < z.length)
          {
            SpecificationNode attrNode = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_ATTRIBUTENAME);
    ...
    if (y != null)
    {
      ...
      {
      	String fileType = y[i++];
      	SpecificationNode node = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_FORMAT);
    ...
    if (x != null)
    {
      ...
      if (x.length() > 0)
      {
      	SpecificationNode node = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_MAXLENGTH);
      	node.setAttribute("value",x);
      	ds.addChild(ds.getChildCount(),node);
      }
    }
    ...
    if (xc != null)
    {
      ...
      if (xc.length() > 0)
      {
      	SpecificationNode node = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PATHNAMEATTRIBUTE);
    ...
    if (xc != null)
    {
      ...
      while (i < mappingCount)
      {
      	...
      	SpecificationNode node = new SpecificationNode(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_PATHMAP);
...
"        <tr>\n"+
"          <td class=\"value\">\n"+
"            "+org.apache.acf.ui.util.Encoder.bodyEscape(strObjectType)+"\n"+
"          </td>\n"+
"          <td class=\"value\">\n"
        );
        if (isAll != null && isAll.equals("true"))
        ...
        else
        {
          ...
          while (k < sn.getChildCount())
          {
            ...
            if (dsn.getType().equals(org.apache.acf.crawler.connectors.DCTM.DCTM.CONFIG_PARAM_ATTRIBUTENAME))
            {
              ...
              out.print(
"            "+org.apache.acf.ui.util.Encoder.bodyEscape(attrName)+"<br/>\n"
              );
            }
          }
        }
...
"    <td class=\"value\">\n"
        ...
        out.print(
"      "+org.apache.acf.ui.util.Encoder.bodyEscape(strContentType)+"<br/>\n"
        );
      }
    }
    if (seenAny)
