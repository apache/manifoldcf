...
<%
    ...
    {
%>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(),"simplereport.Previous")%></a></li>
<%
    }
    else
    {
...
<%
    ...
    {
%>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(),"simplereport.Next")%></a></li>
<%
    }
    else
    {
