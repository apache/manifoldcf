...
%>
		<table class="displaytable">
			...
			<tr>
				<td class="description" colspan="1"><nobr>Authority type:</nobr></td><td class="value" colspan="1"><nobr><%=com.metacarta.ui.util.Encoder.bodyEscape(connectorName)%></nobr></td>
