 ...
 */
public class FilenetLicense {
    public static final String _rcsid = "@(#)$Id$";
    
    // make this a singleton object
    private static FilenetLicense _instance = null;

    private static synchronized void createInstance() {
	if (_instance == null) {
	    _instance = new FilenetLicense();
	}
    }   

    public static FilenetLicense getInstance() {
	if (_instance == null) {
	    createInstance();
	}
	return _instance;
	...
	*/
	...
	try
		...
		lfs = (LicenseFileService)c.newInstance(new Object[]{"/var/lib/metacarta/license",
			(String)constantsClass.getDeclaredField("FILENET_CONNECTOR_PREFIX").get(null)});
	    }
	catch (Exception e)
	    {
