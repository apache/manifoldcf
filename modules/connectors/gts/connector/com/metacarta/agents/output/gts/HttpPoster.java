...
*/
package com.metacarta.agents.output.gts;

import com.metacarta.core.interfaces.*;
import com.metacarta.core.common.Base64;
    ...
    * if not, synchronization blocks are in order when it's used. */
        ...
        throws MetacartaException
    {
        if (userID != null && userID.length() > 0 && password != null)
        {
                try
                {
                        this.encodedCredentials = new com.metacarta.core.common.Base64().encodeByteArray((userID+":"+password).getBytes("UTF-8"));
                }
