    ...
    <td class="headercell">
      <table class="headertable">
        <tr class="headerdaterow">
          <td class="headerdate"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(dateString)%>
          </td>
        </tr>
        <tr class="headerrow">
          <td class="header"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "banner.DocumentIngestion")%>
          </td>
        </tr>
      </table>
    </td>
