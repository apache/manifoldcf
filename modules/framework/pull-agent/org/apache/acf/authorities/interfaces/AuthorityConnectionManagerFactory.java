/* $Id: AuthorityConnectionManagerFactory.java 921329 2010-03-10 12:44:20Z kwright $ */
...
*/
package org.apache.acf.authorities.interfaces;
  ...
  */
    ...
    throws ACFException
  {
    ...
    if (o == null || !(o instanceof IAuthorityConnectionManager))
    {
      ...
      o = new org.apache.acf.authorities.authority.AuthorityConnectionManager(tc,database);
