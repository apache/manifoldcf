...
*/
package com.metacarta.core.system;
...
public class Metacarta
{
	...
	// Property names
	public static final String masterDatabaseNameProperty = "com.metacarta.database.name";
	public static final String masterDatabaseUsernameProperty = "com.metacarta.database.username";
	public static final String masterDatabasePasswordProperty = "com.metacarta.database.password";
	
	public static final String databaseHandleMaxcountProperty = "com.metacarta.database.maxhandles";
	public static final String databaseHandleTimeoutProperty = "com.metacarta.database.handletimeout";

	public static final String synchDirectoryProperty = "com.metacarta.synchdirectory";
	public static final String logDirectoryProperty = "com.metacarta.logdirectory";
	public static final String logConfigFileProperty = "com.metacarta.logconfigfile";

	/** Hack for BPA */
	public static final String configSignalCommandProperty = "com.metacarta.configuration.change.command";
	
	/** Maintenance signal file */
	public static final String maintenanceFileSignalProperty = "com.metacarta.database.maintenanceflag";
	...
	public static synchronized void initializeEnvironment()
	{
		...
		try
		{
			...
			if (isWindows)
			{
				...
				configPath = (String)props.get("com.metacarta.location");
				if (configPath == null)
	...
	*/
	protected static class DatabaseConnectionReleaseThread extends Thread
	{
		...
		{
		        // Clean up the database handles
		        com.metacarta.core.database.ConnectionFactory.releaseAll();
		}
	}
}
