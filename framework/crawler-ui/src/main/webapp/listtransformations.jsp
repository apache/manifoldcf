...
%>
            <tr>
              <td>
                <div class="btn-group">
                  <a data-href='<%="viewtransformation.jsp?connname="+org.apache.manifoldcf.core.util.URLEncoder.encode(name)%>'
                  ...
                  <a data-href='<%="edittransformation.jsp?connname="+org.apache.manifoldcf.core.util.URLEncoder.encode(name)%>'
...
%>
        ...
        <div class="box-footer clearfix">
          <a data-href="edittransformation.jsp" class="link btn btn-primary" role="button"
