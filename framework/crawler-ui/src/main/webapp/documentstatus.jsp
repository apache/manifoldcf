...
<table class="page">
  ...
  <tr>
    ...
    <td class="window">
      <p class="windowtitle"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.DocumentStatus")%>
      </p>
      <%
      ...
      <form class="standardform" name="report" action="execute.jsp" method="POST">
        ...
        <table class="displaytable">
          ...
          <tr>
            <td class="description" colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Connection")%>
            </td>
            ...
            %>
            <td class="description" colspan="1"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Jobs")%>
            </td>
            <td class="value" colspan="1">
          ...
          <tr>
            <td class="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.TimeOffsetFromNowMinutes")%>
            </td>
          ...
          <tr>
            <td class="description"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.DocumentState")%>
            </td>
            <td class="value" colspan="3">
          ...
          <tr>
            <td class="description">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.DocumentIdentifierMatch")%>
              </nobr>
            </td>
            <td class="value" colspan="3">
        ...
        <table class="displaytable">
          <tr class="headerrow">
            <td class="reportcolumnheader">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Identifier")%>
              </nobr>
            </td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("job");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Job")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("state");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.State")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("status");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Status")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("scheduled");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Scheduled")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("action");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.ScheduledAction")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("retrycount");'>
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.RetryCount")%>
              </nobr>
            </a></td>
            <td class="reportcolumnheader"><a href="javascript:void(0);" onclick='javascript:ColumnClick("retrylimit");'>
          ...
          <tr <%="class=\"" + ((zz % 2 == 0) ? "evendatarow" : "odddatarow") + "\""%>>
            ...
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(row.getValue("job").toString())%>
            </td>
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(row.getValue("state").toString())%>
            </td>
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(row.getValue("status").toString())%>
            </td>
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(scheduleTimeString)%>
            </td>
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(scheduledActionString)%>
            </td>
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(retryCountString)%>
            </td>
            <td class="reportcolumncell"><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(retryLimitString)%>
            </td>
          </tr>
          <%
              zz++;
        ...
        <table class="reportfootertable">
          <tr class="reportfooterrow">
            ...
            <td class="reportfootercell">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.Rows")%>
              </nobr>
              <nobr><%=Integer.toString(startRow)%>-<%=(hasMoreRows ? Integer.toString(startRow + rowCount - 1) : "END")%>
              </nobr>
            </td>
            <td class="reportfootercell">
              <nobr><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.RowsPerPage")%>
              </nobr>
        ...
        <table class="displaytable">
          <tr>
            <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.PleaseSelectAtLeastOneJob")%>
            </td>
          </tr>
        </table>
        <%
        ...
        <table class="displaytable">
          <tr>
            <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.PleaseSelectaConnection")%>
            </td>
          </tr>
        </table>
        <%
      ...
      <table class="displaytable">
        ...
        <tr>
          <td class="message"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "documentstatus.PleaseTryAgainLater")%>
          </td>
        </tr>
      </table>
      <%
