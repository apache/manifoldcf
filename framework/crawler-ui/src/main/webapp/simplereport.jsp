...
<script type="text/javascript">
  ...
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.ApacheManifoldCFSimpleHistoryReport")%>',
      ...
      <div class="box box-primary">
        <div class="box-body">
          <table class="table table-bordered">
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.Connection")%>
              </th>
              <td colspan="1">
              ...
              <%
                if (reportConnection.length() > 0) {
              %>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.Activities")%>
              </th>
              <td colspan="1">
              ...
              <td colspan="3">
                <div class="input-group">
                  ...
                  <select class="schedulepulldown" name='reportstartmonth'>
                    ...
                    <option
                        value="0" <%=(startMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.January")%>
                    </option>
                    <option
                        value="1" <%=(startMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.February")%>
                    </option>
                    <option
                        value="2" <%=(startMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.March")%>
                    </option>
                    <option
                        value="3" <%=(startMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.April")%>
                    </option>
                    <option
                        value="4" <%=(startMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.May")%>
                    </option>
                    <option
                        value="5" <%=(startMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.June")%>
                    </option>
                    <option
                        value="6" <%=(startMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.July")%>
                    </option>
                    <option
                        value="7" <%=(startMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.August")%>
                    </option>
                    <option
                        value="8" <%=(startMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.September")%>
                    </option>
                    <option
                        value="9" <%=(startMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.October")%>
                    </option>
                    <option
                        value="10" <%=(startMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.November")%>
                    </option>
                    <option
                        value="11" <%=(startMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.December")%>
                    </option>
                  </select>
                  <span class="label">-</span>
            ...
            <tr>
              <th><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.EndTime")%>
              </th>
              <td colspan="3">
                <div class="input-group">
                  ...
                  <select class="schedulepulldown" name='reportendmonth'>
                    ...
                    <option
                        value="0" <%=(endMonth.equals("0")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.January")%>
                    </option>
                    <option
                        value="1" <%=(endMonth.equals("1")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.February")%>
                    </option>
                    <option
                        value="2" <%=(endMonth.equals("2")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.March")%>
                    </option>
                    <option
                        value="3" <%=(endMonth.equals("3")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.April")%>
                    </option>
                    <option
                        value="4" <%=(endMonth.equals("4")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.May")%>
                    </option>
                    <option
                        value="5" <%=(endMonth.equals("5")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.June")%>
                    </option>
                    <option
                        value="6" <%=(endMonth.equals("6")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.July")%>
                    </option>
                    <option
                        value="7" <%=(endMonth.equals("7")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.August")%>
                    </option>
                    <option
                        value="8" <%=(endMonth.equals("8")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.September")%>
                    </option>
                    <option
                        value="9" <%=(endMonth.equals("9")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.October")%>
                    </option>
                    <option
                        value="10" <%=(endMonth.equals("10")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.November")%>
                    </option>
                    <option
                        value="11" <%=(endMonth.equals("11")) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.December")%>
                    </option>
                  </select>
                  <span class="label">-</span>
            ...
            <tr>
              ...
              <td><input type="text" name="reportentitymatch" class="form-control"
        ...
        <div class="box-body">
          <table class="table table-bordered">
            ...
            <tr>
              ...
              <td><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(resultCode)%>
              </td>
              <td><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(row.getValue("bytes").toString())%>
              </td>
              <td><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(row.getValue("elapsedtime").toString())%>
              </td>
              <td><%=org.apache.manifoldcf.ui.util.Encoder.bodyEscape(resultDescription)%>
              </td>
            </tr>
            <%
                zz++;
        ...
        <div class="box-footer clearfix">
          <ul class="pagination pagination-sm no-margin pull-left">
            <%
              if (startRow == 0) {
            %>
            <li><a href="#"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.Previous")%>
            </a></li>
            <%
            } else {
            %>
            <li>
              <a href="javascript:void(0);"
                 ...
                 alt="<%=Messages.getAttributeString(pageContext.getRequest().getLocale(),"simplereport.PreviousPage")%>"><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.Previous")%>
              </a></li>
            <%
              }
          ...
          <ul class="pagination pagination-sm no-margin pull-right">
            <li class="pad">
              <span class="label label-primary">
                  <%=Messages.getBodyString(pageContext.getRequest().getLocale(), "simplereport.Rows")%>
                <%=Integer.toString(startRow)%>
                  -<%=(hasMoreRows ? Integer.toString(startRow + rowCount - 1) : "END")%>
                </span>
            </li>
