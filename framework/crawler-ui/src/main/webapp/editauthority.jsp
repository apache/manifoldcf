...
<script type="text/javascript">
  ...
  $.ManifoldCF.setTitle('<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.ApacheManifoldCFEditAuthority")%>',
      '<%=title%>',
      'authorities'
  );
...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="callout callout-warning">
      <p><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoAuthorityGroupsDefinedCreateOneFirst")%>
      </p>
    </div>
    <%
    ...
    %>
    <div class="callout callout-warning">
      <p><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoAuthorityConnectorsRegistered")%>
      </p>
    </div>
    <%
    } else {
        ...
        <div class="box-body">
          ...
          <div class="tab-pane active" id="tab_<%=activeTab%>">
            <div class="form-group">
              <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NameColon")%>
              </label>
              <%
          ...
          <div class="tab-pane active" id="tab_<%=activeTab%>">
            <div class="form-group">
              <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.ConnectionTypeColon")%>
              </label>
            ...
            <div class="form-group">
              <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.AuthorityGroupColon")%>
              </label>
              <select name="authoritygroup" class="form-control">
                <option
                    value=""><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.SelectAGroup")%>
                </option>
                <%
            ...
            <div class="form-group">
              <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.AuthorizationDomainColon")%>
              </label>
              <select name="authdomain" class="form-control">
                <option
                    value="" <%=(authDomain == null || authDomain.length() == 0) ? "selected=\"selected\"" : ""%>><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.DefaultDomainNone")%>
                </option>
                <%
          ...
          <div class="tab-pane active" id="tab_<%=activeTab%>">
            <div class="form-group">
              <strong><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.PrerequisiteUserMappingColon")%>
              </strong>
              ...
              <div class="radio">
                <label>
                  ...
                  <input type="radio" name="prerequisites" value=""
                         checked="true"/>&nbsp;<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoPrerequisites")%>
                  <br/>
                  <%
                  } else {
                  %>
                  <input type="radio" name="prerequisites"
                         value=""/>&nbsp;<%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.NoPrerequisites")%>
                  <br/>
                  <%
                    }
          ...
          <div class="tab-pane active" id="tab_<%=activeTab%>">
            <div class="form-group">
              <label><%=Messages.getBodyString(pageContext.getRequest().getLocale(), "editauthority.MaxConnectionsColon")%>
              </label>
